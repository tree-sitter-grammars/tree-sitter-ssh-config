...
enum {
  ...
  aux_sym__use_keychain_token1 = 144,
  aux_sym__user_known_hosts_file_token1 = 145,
  aux_sym__verify_host_key_dns_token1 = 146,
  aux_sym__visual_host_key_token1 = 147,
  aux_sym__xauth_location_token1 = 148,
  sym_ipqos = 149,
  sym_verbosity = 150,
  sym_facility = 151,
  sym_authentication = 152,
  sym_cipher = 153,
  sym_kex = 154,
  sym_key_sig = 155,
  sym_mac = 156,
  sym_sig = 157,
  aux_sym__file_token_token1 = 158,
  aux_sym__hosts_token_token1 = 159,
  aux_sym__hostname_token_token1 = 160,
  aux_sym__proxy_token_token1 = 161,
  sym_token = 162,
  anon_sym_DOLLAR = 163,
  sym__var_name = 164,
  anon_sym_DOLLAR_LBRACE = 165,
  anon_sym_RBRACE = 166,
  anon_sym_yes = 167,
  anon_sym_no = 168,
  sym__number = 169,
  aux_sym_bytes_token1 = 170,
  aux_sym_time_token1 = 171,
  aux_sym_time_token2 = 172,
  aux_sym_time_token3 = 173,
  aux_sym_time_token4 = 174,
  aux_sym_time_token5 = 175,
  sym_comment = 176,
  aux_sym__sep_token1 = 177,
  sym__space = 178,
  sym__eol = 179,
  sym_config = 180,
  sym_host_declaration = 181,
  sym_match_declaration = 182,
  sym_condition = 183,
  sym__all = 184,
  sym__match_canonical = 185,
  sym__match_final = 186,
  sym__match_exec = 187,
  sym__match_localnetwork = 188,
  sym__match_host = 189,
  sym__match_originalhost = 190,
  sym__match_tagged = 191,
  sym__match_user = 192,
  sym__match_localuser = 193,
  sym__match_value = 194,
  sym__declarations = 195,
  sym_parameter = 196,
  sym__add_keys_to_agent = 197,
  sym__address_family = 198,
  sym__batch_mode = 199,
  sym__bind_address = 200,
  sym__bind_interface = 201,
  sym__canonical_domains = 202,
  sym__canonicalize_fallback_local = 203,
  sym__canonicalize_hostname = 204,
  sym__canonicalize_max_dots = 205,
  sym__canonicalize_permitted_cnames = 206,
  sym__cnames_map = 207,
  sym__ca_signature_algorithms = 208,
  sym__certificate_file = 209,
  sym__check_host_ip = 210,
  sym__ciphers = 211,
  sym__clear_all_forwardings = 212,
  sym__compression = 213,
  sym__connection_attempts = 214,
  sym__connect_timeout = 215,
  sym__control_master = 216,
  sym__control_persist = 217,
  sym__control_path = 218,
  sym__dynamic_forward = 219,
  sym__forward_value_inner = 220,
  sym__dynamic_forward_value = 221,
  sym__enable_escape_command_line = 222,
  sym__enable_ssh_keysign = 223,
  sym__escape_char = 224,
  sym__exit_on_forward_failure = 225,
  sym__fingerprint_hash = 226,
  sym__fork_after_authentication = 227,
  sym__forward_agent = 228,
  sym__forward_x11 = 229,
  sym__forward_x11_timeout = 230,
  sym__forward_x11_trusted = 231,
  sym__global_known_hosts_file = 232,
  sym__gssapi_authentication = 233,
  sym__gssapi_delegate_credentials = 234,
  sym__hostbased_accepted_algorithms = 235,
  sym__hostbased_authentication = 236,
  sym__host_key_algorithms = 237,
  sym__host_key_alias = 238,
  sym__hostname = 239,
  sym__identities_only = 240,
  sym__identity_agent = 241,
  sym__identity_file = 242,
  sym__ignore_unknown = 243,
  sym__include = 244,
  sym__ipqos = 245,
  sym__kbd_interactive_authentication = 246,
  sym__kex_algorithms = 247,
  sym__known_hosts_command = 248,
  sym__local_command = 249,
  sym__local_forward = 250,
  sym__forward_value1 = 251,
  sym__forward_value2 = 252,
  sym__log_level = 253,
  sym__log_verbose = 254,
  sym__log_verbose_value = 255,
  sym__log_verbose_quoted = 256,
  sym__macs = 257,
  sym__no_host_authentication_for_localhost = 258,
  sym__number_of_password_prompts = 259,
  sym__password_authentication = 260,
  sym__permit_local_command = 261,
  sym__permit_remote_open = 262,
  sym__permit_remote_open_value = 263,
  sym__pkcs11_provider = 264,
  sym__port = 265,
  sym__preferred_authentications = 266,
  sym__proxy_command = 267,
  sym__proxy_jump = 268,
  sym__proxy_use_fdpass = 269,
  sym__pubkey_accepted_algorithms = 270,
  sym__pubkey_authentication = 271,
  sym__pubkey_authentication_arg = 272,
  sym__rekey_limit = 273,
  sym__remote_command = 274,
  sym__remote_forward = 275,
  sym__request_tty = 276,
  sym__required_rsa_size = 277,
  sym__revoked_host_keys = 278,
  sym__security_key_provider = 279,
  sym__send_env = 280,
  sym__send_env_value = 281,
  sym__server_alive_count_max = 282,
  sym__server_alive_interval = 283,
  sym__session_type = 284,
  sym__set_env = 285,
  sym__set_env_value = 286,
  sym__stdin_null = 287,
  sym__stream_local_bind_mask = 288,
  sym__stream_local_bind_unlink = 289,
  sym__strict_host_key_checking = 290,
  sym__syslog_facility = 291,
  sym__tcp_keep_alive = 292,
  sym__tag = 293,
  sym__tunnel = 294,
  sym__tunnel_device = 295,
  sym__update_host_keys = 296,
  sym__use_keychain = 297,
  sym__user = 298,
  sym__user_known_hosts_file = 299,
  sym__verify_host_key_dns = 300,
  sym__visual_host_key = 301,
  sym__xauth_location = 302,
  sym__file_token = 303,
  sym__hosts_token = 304,
  sym__hostname_token = 305,
  sym__proxy_token = 306,
  sym__var_value = 307,
  sym_variable = 308,
  sym__file_string = 309,
  sym__hosts_string = 310,
  sym__hostname_string = 311,
  sym__proxy_string = 312,
  sym__token_string = 313,
  sym__string = 314,
  sym__file_pattern_vars = 315,
  sym__pattern = 316,
  sym__boolean = 317,
  sym_number = 318,
  sym_bytes = 319,
  sym_time = 320,
  sym__sep = 321,
  aux_sym_config_repeat1 = 322,
  aux_sym_host_declaration_repeat1 = 323,
  aux_sym_match_declaration_repeat1 = 324,
  aux_sym__match_exec_repeat1 = 325,
  aux_sym__match_exec_repeat2 = 326,
  aux_sym__match_localnetwork_repeat1 = 327,
  aux_sym__match_localnetwork_repeat2 = 328,
  aux_sym__match_value_repeat1 = 329,
  aux_sym__match_value_repeat2 = 330,
  aux_sym__match_value_repeat3 = 331,
  aux_sym__match_value_repeat4 = 332,
  aux_sym__declarations_repeat1 = 333,
  aux_sym__canonical_domains_repeat1 = 334,
  aux_sym__canonicalize_permitted_cnames_repeat1 = 335,
  aux_sym__cnames_map_repeat1 = 336,
  aux_sym__ca_signature_algorithms_repeat1 = 337,
  aux_sym__ciphers_repeat1 = 338,
  aux_sym__dynamic_forward_repeat1 = 339,
  aux_sym__global_known_hosts_file_repeat1 = 340,
  aux_sym__hostbased_accepted_algorithms_repeat1 = 341,
  aux_sym__ignore_unknown_repeat1 = 342,
  aux_sym__kex_algorithms_repeat1 = 343,
  aux_sym__log_verbose_repeat1 = 344,
  aux_sym__log_verbose_repeat2 = 345,
  aux_sym__log_verbose_value_repeat1 = 346,
  aux_sym__macs_repeat1 = 347,
  aux_sym__permit_remote_open_repeat1 = 348,
  aux_sym__preferred_authentications_repeat1 = 349,
  aux_sym__remote_command_repeat1 = 350,
  aux_sym__send_env_repeat1 = 351,
  aux_sym__send_env_value_repeat1 = 352,
  aux_sym__set_env_repeat1 = 353,
  aux_sym__user_known_hosts_file_repeat1 = 354,
  aux_sym__file_string_repeat1 = 355,
  aux_sym__file_string_repeat2 = 356,
  aux_sym__hosts_string_repeat1 = 357,
  aux_sym__hostname_string_repeat1 = 358,
  aux_sym__hostname_string_repeat2 = 359,
  aux_sym__proxy_string_repeat1 = 360,
  aux_sym__token_string_repeat1 = 361,
  aux_sym__string_repeat1 = 362,
  aux_sym__string_repeat2 = 363,
  aux_sym__file_pattern_vars_repeat1 = 364,
  aux_sym__file_pattern_vars_repeat2 = 365,
  anon_alias_sym_User = 366,
  anon_alias_sym_host = 367,
  alias_sym_pattern = 368,
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (lookahead == 'H' ||
          lookahead == 'h') ADVANCE(1833);
      if (lookahead == 'M' ||
          lookahead == 'm') ADVANCE(1833);
      if (lookahead == 'W' ||
          lookahead == 'w') ADVANCE(1833);
      if (lookahead == 'G' ||
          lookahead == 'K' ||
          lookahead == 'g' ||
          lookahead == 'k') ADVANCE(1833);
    ...
    case 3:
      ...
      if (('1' <= lookahead && lookahead <= '9')) ADVANCE(2056);
      END_STATE();
    case 4:
      if (lookahead == '\n') ADVANCE(2067);
      if (lookahead == '\r') ADVANCE(1);
    ...
    case 16:
      ...
      if (lookahead == 'M' ||
          lookahead == 'm') ADVANCE(2061);
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2062);
      if (lookahead == 'W' ||
          lookahead == 'w') ADVANCE(2058);
      if (('1' <= lookahead && lookahead <= '7')) ADVANCE(1818);
      END_STATE();
    case 17:
      if (lookahead == '\n') ADVANCE(2067);
      if (lookahead == '\r') ADVANCE(1);
    ...
    case 24:
      ...
      if (lookahead == '*') ADVANCE(1868);
      if (lookahead == '0') ADVANCE(1833);
      if (('1' <= lookahead && lookahead <= '9')) ADVANCE(1840);
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != '\n' &&
          lookahead != '\r' &&
    ...
    case 176:
      ...
      END_STATE();
    case 177:
      if (lookahead == '4') ADVANCE(2021);
      END_STATE();
    case 178:
      if (lookahead == '4') ADVANCE(69);
      END_STATE();
    case 179:
      if (lookahead == '4') ADVANCE(2018);
      END_STATE();
    case 180:
      if (lookahead == '4') ADVANCE(2025);
      END_STATE();
    case 181:
    ...
    case 207:
      ...
      END_STATE();
    case 208:
      if (lookahead == '6') ADVANCE(1918);
      END_STATE();
    case 209:
      if (lookahead == '6') ADVANCE(2021);
      END_STATE();
    case 210:
      if (lookahead == '6') ADVANCE(2019);
      END_STATE();
    case 211:
      if (lookahead == '6') ADVANCE(2018);
      END_STATE();
    case 212:
      if (lookahead == '6') ADVANCE(2025);
      END_STATE();
    case 213:
    ...
    case 375:
      ...
      if (('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'z')) ADVANCE(2050);
      END_STATE();
    case 376:
      if (lookahead == 'd') ADVANCE(2016);
      END_STATE();
    case 377:
    ...
    case 381:
      ...
      if (('0' <= lookahead && lookahead <= '7')) ADVANCE(1815);
      END_STATE();
    case 382:
    ...
    case 501:
      ...
      if (lookahead == 'M' ||
          lookahead == 'm') ADVANCE(1399);
      if (lookahead == 'Q' ||
          lookahead == 'q') ADVANCE(1740);
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(1430);
      END_STATE();
    case 502:
    ...
    case 819:
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(1245);
      END_STATE();
    case 820:
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(1431);
      END_STATE();
    case 821:
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(1132);
      END_STATE();
    case 822:
      if (lookahead == 'C' ||
    ...
    case 857:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(1451);
      if (lookahead == 'J' ||
          lookahead == 'j') ADVANCE(1744);
      if (lookahead == 'U' ||
    ...
    case 1049:
      if (lookahead == 'F' ||
          lookahead == 'f') ADVANCE(1414);
      END_STATE();
    case 1050:
      if (lookahead == 'F' ||
          lookahead == 'f') ADVANCE(1149);
      END_STATE();
    case 1051:
      if (lookahead == 'F' ||
          lookahead == 'f') ADVANCE(1160);
      END_STATE();
    case 1052:
      if (lookahead == 'F' ||
          lookahead == 'f') ADVANCE(781);
      if (lookahead == 'H' ||
    ...
    case 1057:
      if (lookahead == 'F' ||
          lookahead == 'f') ADVANCE(1469);
      END_STATE();
    case 1058:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(2001);
      END_STATE();
    case 1059:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(1996);
      END_STATE();
    case 1060:
      if (lookahead == 'G' ||
    ...
    case 1193:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(1992);
      END_STATE();
    case 1194:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(1995);
      END_STATE();
    case 1195:
      if (lookahead == 'K' ||
    ...
    case 1212:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(1261);
      END_STATE();
    case 1213:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(1096);
      END_STATE();
    case 1214:
      if (lookahead == 'K' ||
    ...
    case 1477:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(1199);
      END_STATE();
    case 1478:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(1959);
      END_STATE();
    case 1479:
      if (lookahead == 'P' ||
    ...
    case 1499:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(1561);
      END_STATE();
    case 1500:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(1731);
      END_STATE();
    case 1501:
      if (lookahead == 'Q' ||
          lookahead == 'q') ADVANCE(1402);
      END_STATE();
    case 1502:
      if (lookahead == 'R' ||
    ...
    case 1621:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(1663);
      END_STATE();
    case 1622:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(1409);
      END_STATE();
    case 1623:
      if (lookahead == 'S' ||
    ...
    case 1651:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(1922);
      END_STATE();
    case 1652:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(1950);
      END_STATE();
    case 1653:
      if (lookahead == 'T' ||
    ...
    case 1756:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(1734);
      END_STATE();
    case 1757:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(1735);
      END_STATE();
    case 1758:
      if (lookahead == 'U' ||
    ...
    case 1789:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(1978);
      END_STATE();
    case 1790:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(1875);
      END_STATE();
    case 1791:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(2010);
      END_STATE();
    case 1792:
      if (lookahead == 'Y' ||
    ...
    case 1793:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(1999);
      END_STATE();
    case 1794:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(1237);
      END_STATE();
    case 1795:
      if (lookahead == 'Y' ||
    ...
    case 1800:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(1619);
      END_STATE();
    case 1801:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(1570);
      END_STATE();
    case 1802:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(1572);
      END_STATE();
    case 1803:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(1488);
      END_STATE();
    case 1804:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(1621);
      END_STATE();
    case 1805:
      if (lookahead == 'Y' ||
    ...
    case 1811:
      ...
      END_STATE();
    case 1812:
      if (('1' <= lookahead && lookahead <= '3')) ADVANCE(2012);
      END_STATE();
    case 1813:
      if (('0' <= lookahead && lookahead <= '7')) ADVANCE(2012);
      END_STATE();
    case 1814:
      if (('0' <= lookahead && lookahead <= '7')) ADVANCE(1994);
      END_STATE();
    case 1815:
      if (('0' <= lookahead && lookahead <= '7')) ADVANCE(1993);
      END_STATE();
    case 1816:
      if (('0' <= lookahead && lookahead <= '7')) ADVANCE(2015);
      END_STATE();
    case 1817:
      if (('0' <= lookahead && lookahead <= '7')) ADVANCE(1814);
      END_STATE();
    case 1818:
      if (('0' <= lookahead && lookahead <= '7')) ADVANCE(1815);
      END_STATE();
    ...
    case 1839:
      ACCEPT_TOKEN(aux_sym__match_exec_token2);
      if (lookahead == '%' ||
          lookahead == 'h') ADVANCE(2028);
      END_STATE();
    case 1840:
      ACCEPT_TOKEN(aux_sym__match_exec_token2);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(2056);
      END_STATE();
    case 1841:
      ACCEPT_TOKEN(aux_sym__match_exec_token2);
      if (aux_sym__file_token_token1_character_set_1(lookahead)) ADVANCE(2026);
      END_STATE();
    case 1842:
    ...
    case 1914:
      ACCEPT_TOKEN(aux_sym__escape_char_token2);
      if (('A' <= lookahead && lookahead <= 'Z') ||
          ('a' <= lookahead && lookahead <= 'z')) ADVANCE(1912);
      END_STATE();
    case 1915:
    ...
    case 1975:
      ACCEPT_TOKEN(aux_sym__remote_command_token2);
      if (aux_sym__hosts_token_token1_character_set_1(lookahead)) ADVANCE(2027);
      END_STATE();
    case 1976:
      ACCEPT_TOKEN(aux_sym__remote_command_token2);
      if (sym_token_character_set_1(lookahead)) ADVANCE(2030);
      END_STATE();
    case 1977:
    ...
    case 2014:
      ACCEPT_TOKEN(sym_verbosity);
      if (('1' <= lookahead && lookahead <= '3')) ADVANCE(2013);
      END_STATE();
    case 2015:
    ...
    case 2033:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('b' <= lookahead && lookahead <= 'z')) ADVANCE(2050);
      END_STATE();
    case 2034:
      ACCEPT_TOKEN(sym__var_name);
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [5] = {
    ...
    [aux_sym__add_keys_to_agent_token1] = ACTIONS(521),
    [aux_sym__address_family_token1] = ACTIONS(524),
    [aux_sym__batch_mode_token1] = ACTIONS(527),
    [aux_sym__bind_address_token1] = ACTIONS(530),
    [aux_sym__bind_interface_token1] = ACTIONS(533),
    [aux_sym__canonical_domains_token1] = ACTIONS(536),
    [aux_sym__canonicalize_fallback_local_token1] = ACTIONS(539),
    [aux_sym__canonicalize_hostname_token1] = ACTIONS(542),
    [aux_sym__canonicalize_max_dots_token1] = ACTIONS(545),
    [aux_sym__canonicalize_permitted_cnames_token1] = ACTIONS(548),
    [aux_sym__ca_signature_algorithms_token1] = ACTIONS(551),
    [aux_sym__certificate_file_token1] = ACTIONS(554),
    [aux_sym__check_host_ip_token1] = ACTIONS(557),
    [aux_sym__ciphers_token1] = ACTIONS(560),
    [aux_sym__clear_all_forwardings_token1] = ACTIONS(563),
    [aux_sym__compression_token1] = ACTIONS(566),
    [aux_sym__connection_attempts_token1] = ACTIONS(569),
    [aux_sym__connect_timeout_token1] = ACTIONS(572),
    [aux_sym__control_master_token1] = ACTIONS(575),
    [aux_sym__control_persist_token1] = ACTIONS(578),
    [aux_sym__control_path_token1] = ACTIONS(581),
    [aux_sym__dynamic_forward_token1] = ACTIONS(584),
    [aux_sym__enable_escape_command_line_token1] = ACTIONS(587),
    [aux_sym__enable_ssh_keysign_token1] = ACTIONS(590),
    [aux_sym__escape_char_token1] = ACTIONS(593),
    [aux_sym__exit_on_forward_failure_token1] = ACTIONS(596),
    [aux_sym__fingerprint_hash_token1] = ACTIONS(599),
    [aux_sym__fork_after_authentication_token1] = ACTIONS(602),
    [aux_sym__forward_agent_token1] = ACTIONS(605),
    [aux_sym__forward_x11_token1] = ACTIONS(608),
    [aux_sym__forward_x11_timeout_token1] = ACTIONS(611),
    [aux_sym__forward_x11_trusted_token1] = ACTIONS(614),
    [aux_sym__global_known_hosts_file_token1] = ACTIONS(617),
    [aux_sym__gssapi_authentication_token1] = ACTIONS(620),
    [aux_sym__gssapi_delegate_credentials_token1] = ACTIONS(623),
    [aux_sym__hostbased_accepted_algorithms_token1] = ACTIONS(626),
    [aux_sym__hostbased_accepted_algorithms_token2] = ACTIONS(626),
    [aux_sym__hostbased_authentication_token1] = ACTIONS(629),
    [aux_sym__host_key_algorithms_token1] = ACTIONS(632),
    [aux_sym__host_key_alias_token1] = ACTIONS(635),
    [aux_sym__hostname_token1] = ACTIONS(638),
    [aux_sym__identities_only_token1] = ACTIONS(641),
    [aux_sym__identity_agent_token1] = ACTIONS(644),
    [aux_sym__identity_file_token1] = ACTIONS(647),
    [aux_sym__ignore_unknown_token1] = ACTIONS(650),
    [aux_sym__include_token1] = ACTIONS(653),
    [aux_sym__ipqos_token1] = ACTIONS(656),
    [aux_sym__kbd_interactive_authentication_token1] = ACTIONS(659),
    [aux_sym__kbd_interactive_authentication_token2] = ACTIONS(659),
    [aux_sym__kex_algorithms_token1] = ACTIONS(662),
    [aux_sym__known_hosts_command_token1] = ACTIONS(665),
    [aux_sym__local_command_token1] = ACTIONS(668),
    [aux_sym__local_forward_token1] = ACTIONS(671),
    [aux_sym__log_level_token1] = ACTIONS(674),
    [aux_sym__log_verbose_token1] = ACTIONS(677),
    [aux_sym__macs_token1] = ACTIONS(680),
    [aux_sym__no_host_authentication_for_localhost_token1] = ACTIONS(683),
    [aux_sym__number_of_password_prompts_token1] = ACTIONS(686),
    [aux_sym__password_authentication_token1] = ACTIONS(689),
    [aux_sym__permit_local_command_token1] = ACTIONS(692),
    [aux_sym__permit_remote_open_token1] = ACTIONS(695),
    [aux_sym__pkcs11_provider_token1] = ACTIONS(698),
    [aux_sym__port_token1] = ACTIONS(701),
    [aux_sym__preferred_authentications_token1] = ACTIONS(704),
    [aux_sym__proxy_command_token1] = ACTIONS(707),
    [aux_sym__proxy_jump_token1] = ACTIONS(710),
    [aux_sym__proxy_use_fdpass_token1] = ACTIONS(713),
    [aux_sym__pubkey_accepted_algorithms_token1] = ACTIONS(716),
    [aux_sym__pubkey_authentication_token1] = ACTIONS(719),
    [aux_sym__rekey_limit_token1] = ACTIONS(722),
    [aux_sym__remote_command_token1] = ACTIONS(725),
    [aux_sym__remote_forward_token1] = ACTIONS(728),
    [aux_sym__request_tty_token1] = ACTIONS(731),
    [aux_sym__required_rsa_size_token1] = ACTIONS(734),
    [aux_sym__revoked_host_keys_token1] = ACTIONS(737),
    [aux_sym__security_key_provider_token1] = ACTIONS(740),
    [aux_sym__send_env_token1] = ACTIONS(743),
    [aux_sym__server_alive_count_max_token1] = ACTIONS(746),
    [aux_sym__server_alive_interval_token1] = ACTIONS(749),
    [aux_sym__session_type_token1] = ACTIONS(752),
    [aux_sym__stdin_null_token1] = ACTIONS(755),
    [aux_sym__stream_local_bind_mask_token1] = ACTIONS(758),
    [aux_sym__stream_local_bind_unlink_token1] = ACTIONS(761),
    [aux_sym__strict_host_key_checking_token1] = ACTIONS(764),
    [aux_sym__syslog_facility_token1] = ACTIONS(767),
    [aux_sym__tcp_keep_alive_token1] = ACTIONS(770),
    [aux_sym__tag_token1] = ACTIONS(773),
    [aux_sym__tunnel_token1] = ACTIONS(776),
    [aux_sym__tunnel_device_token1] = ACTIONS(779),
    [aux_sym__update_host_keys_token1] = ACTIONS(782),
    [aux_sym__use_keychain_token1] = ACTIONS(785),
    [aux_sym__user_known_hosts_file_token1] = ACTIONS(788),
    [aux_sym__verify_host_key_dns_token1] = ACTIONS(791),
    [aux_sym__visual_host_key_token1] = ACTIONS(794),
    [aux_sym__xauth_location_token1] = ACTIONS(797),
  ...
  [19] = {
    ...
    [aux_sym_host_declaration_token1] = ACTIONS(516),
    [aux_sym_match_declaration_token1] = ACTIONS(514),
    [aux_sym__match_user_token1] = ACTIONS(516),
    [aux_sym__add_keys_to_agent_token1] = ACTIONS(514),
    [aux_sym__address_family_token1] = ACTIONS(514),
    [aux_sym__batch_mode_token1] = ACTIONS(514),
    [aux_sym__bind_address_token1] = ACTIONS(514),
    [aux_sym__bind_interface_token1] = ACTIONS(514),
    [aux_sym__canonical_domains_token1] = ACTIONS(514),
    [aux_sym__canonicalize_fallback_local_token1] = ACTIONS(514),
    [aux_sym__canonicalize_hostname_token1] = ACTIONS(514),
    [aux_sym__canonicalize_max_dots_token1] = ACTIONS(514),
    [aux_sym__canonicalize_permitted_cnames_token1] = ACTIONS(514),
    [aux_sym__ca_signature_algorithms_token1] = ACTIONS(514),
    [aux_sym__certificate_file_token1] = ACTIONS(514),
    [aux_sym__check_host_ip_token1] = ACTIONS(514),
    [aux_sym__ciphers_token1] = ACTIONS(514),
    [aux_sym__clear_all_forwardings_token1] = ACTIONS(514),
    [aux_sym__compression_token1] = ACTIONS(514),
    [aux_sym__connection_attempts_token1] = ACTIONS(514),
    [aux_sym__connect_timeout_token1] = ACTIONS(514),
    [aux_sym__control_master_token1] = ACTIONS(514),
    [aux_sym__control_persist_token1] = ACTIONS(514),
    [aux_sym__control_path_token1] = ACTIONS(514),
    [aux_sym__dynamic_forward_token1] = ACTIONS(514),
    [aux_sym__enable_escape_command_line_token1] = ACTIONS(514),
    [aux_sym__enable_ssh_keysign_token1] = ACTIONS(514),
    [aux_sym__escape_char_token1] = ACTIONS(514),
    [aux_sym__exit_on_forward_failure_token1] = ACTIONS(514),
    [aux_sym__fingerprint_hash_token1] = ACTIONS(514),
    [aux_sym__fork_after_authentication_token1] = ACTIONS(514),
    [aux_sym__forward_agent_token1] = ACTIONS(514),
    [aux_sym__forward_x11_token1] = ACTIONS(516),
    [aux_sym__forward_x11_timeout_token1] = ACTIONS(514),
    [aux_sym__forward_x11_trusted_token1] = ACTIONS(514),
    [aux_sym__global_known_hosts_file_token1] = ACTIONS(514),
    [aux_sym__gssapi_authentication_token1] = ACTIONS(514),
    [aux_sym__gssapi_delegate_credentials_token1] = ACTIONS(514),
    [aux_sym__hostbased_accepted_algorithms_token1] = ACTIONS(514),
    [aux_sym__hostbased_accepted_algorithms_token2] = ACTIONS(514),
    [aux_sym__hostbased_authentication_token1] = ACTIONS(514),
    [aux_sym__host_key_algorithms_token1] = ACTIONS(514),
    [aux_sym__host_key_alias_token1] = ACTIONS(514),
    [aux_sym__hostname_token1] = ACTIONS(514),
    [aux_sym__identities_only_token1] = ACTIONS(514),
    [aux_sym__identity_agent_token1] = ACTIONS(514),
    [aux_sym__identity_file_token1] = ACTIONS(514),
    [aux_sym__ignore_unknown_token1] = ACTIONS(514),
    [aux_sym__include_token1] = ACTIONS(514),
    [aux_sym__ipqos_token1] = ACTIONS(514),
    [aux_sym__kbd_interactive_authentication_token1] = ACTIONS(514),
    [aux_sym__kbd_interactive_authentication_token2] = ACTIONS(514),
    [aux_sym__kex_algorithms_token1] = ACTIONS(514),
    [aux_sym__known_hosts_command_token1] = ACTIONS(514),
    [aux_sym__local_command_token1] = ACTIONS(514),
    [aux_sym__local_forward_token1] = ACTIONS(514),
    [aux_sym__log_level_token1] = ACTIONS(514),
    [aux_sym__log_verbose_token1] = ACTIONS(514),
    [aux_sym__macs_token1] = ACTIONS(514),
    [aux_sym__no_host_authentication_for_localhost_token1] = ACTIONS(514),
    [aux_sym__number_of_password_prompts_token1] = ACTIONS(514),
    [aux_sym__password_authentication_token1] = ACTIONS(514),
    [aux_sym__permit_local_command_token1] = ACTIONS(514),
    [aux_sym__permit_remote_open_token1] = ACTIONS(514),
    [aux_sym__pkcs11_provider_token1] = ACTIONS(514),
    [aux_sym__port_token1] = ACTIONS(514),
    [aux_sym__preferred_authentications_token1] = ACTIONS(514),
    [aux_sym__proxy_command_token1] = ACTIONS(514),
    [aux_sym__proxy_jump_token1] = ACTIONS(514),
    [aux_sym__proxy_use_fdpass_token1] = ACTIONS(514),
    [aux_sym__pubkey_accepted_algorithms_token1] = ACTIONS(514),
    [aux_sym__pubkey_authentication_token1] = ACTIONS(514),
    [aux_sym__rekey_limit_token1] = ACTIONS(514),
    [aux_sym__remote_command_token1] = ACTIONS(514),
    [aux_sym__remote_forward_token1] = ACTIONS(514),
    [aux_sym__request_tty_token1] = ACTIONS(514),
    [aux_sym__required_rsa_size_token1] = ACTIONS(514),
    [aux_sym__revoked_host_keys_token1] = ACTIONS(514),
    [aux_sym__security_key_provider_token1] = ACTIONS(514),
    [aux_sym__send_env_token1] = ACTIONS(514),
    [aux_sym__server_alive_count_max_token1] = ACTIONS(514),
    [aux_sym__server_alive_interval_token1] = ACTIONS(514),
    [aux_sym__session_type_token1] = ACTIONS(514),
    [aux_sym__stdin_null_token1] = ACTIONS(514),
    [aux_sym__stream_local_bind_mask_token1] = ACTIONS(514),
    [aux_sym__stream_local_bind_unlink_token1] = ACTIONS(514),
    [aux_sym__strict_host_key_checking_token1] = ACTIONS(514),
    [aux_sym__syslog_facility_token1] = ACTIONS(514),
    [aux_sym__tcp_keep_alive_token1] = ACTIONS(514),
    [aux_sym__tag_token1] = ACTIONS(514),
    [aux_sym__tunnel_token1] = ACTIONS(516),
    [aux_sym__tunnel_device_token1] = ACTIONS(514),
    [aux_sym__update_host_keys_token1] = ACTIONS(514),
    [aux_sym__use_keychain_token1] = ACTIONS(514),
    [aux_sym__user_known_hosts_file_token1] = ACTIONS(514),
    [aux_sym__verify_host_key_dns_token1] = ACTIONS(514),
    [aux_sym__visual_host_key_token1] = ACTIONS(514),
    [aux_sym__xauth_location_token1] = ACTIONS(514),
  ...
  [20] = {
    ...
    [aux_sym__use_keychain_token1] = ACTIONS(812),
  ...
  [21] = {
    ...
    [aux_sym__use_keychain_token1] = ACTIONS(816),
  ...
  [22] = {
    ...
    [aux_sym__use_keychain_token1] = ACTIONS(820),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [496] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_config_repeat1, 2), SHIFT_REPEAT(6),
  ...
  [506] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__declarations, 1),
  [508] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__declarations, 1),
  [510] = {.entry = {.count = 1, .reusable = true}}, SHIFT(595),
  [512] = {.entry = {.count = 1, .reusable = true}}, SHIFT(18),
  [514] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2),
  [516] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__declarations_repeat1, 2),
  [518] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(282),
  [521] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(283),
  [524] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(285),
  [527] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(290),
  [530] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(291),
  [533] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(295),
  [536] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(296),
  [539] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(297),
  [542] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(299),
  [545] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(313),
  [548] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(314),
  [551] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(315),
  [554] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(317),
  [557] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(318),
  [560] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(320),
  [563] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(321),
  [566] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(324),
  [569] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(330),
  [572] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(332),
  [575] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(333),
  [578] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(336),
  [581] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(337),
  [584] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(342),
  [587] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(346),
  [590] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(347),
  [593] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(351),
  [596] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(352),
  [599] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(353),
  [602] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(354),
  [605] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(355),
  [608] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(357),
  [611] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(358),
  [614] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(360),
  [617] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(361),
  [620] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(363),
  [623] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(364),
  [626] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(365),
  [629] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(366),
  [632] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(368),
  [635] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(370),
  [638] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(371),
  [641] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(375),
  [644] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(377),
  [647] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(378),
  [650] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(379),
  [653] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(382),
  [656] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(383),
  [659] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(384),
  [662] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(387),
  [665] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(389),
  [668] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(392),
  [671] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(393),
  [674] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(394),
  [677] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(395),
  [680] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(397),
  [683] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(398),
  [686] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(399),
  [689] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(400),
  [692] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(403),
  [695] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(405),
  [698] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(406),
  [701] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(407),
  [704] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(479),
  [707] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(412),
  [710] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(414),
  [713] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(418),
  [716] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(420),
  [719] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(421),
  [722] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(422),
  [725] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(424),
  [728] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(427),
  [731] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(428),
  [734] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(429),
  [737] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(431),
  [740] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(433),
  [743] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(434),
  [746] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(436),
  [749] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(437),
  [752] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(439),
  [755] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(444),
  [758] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(446),
  [761] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(447),
  [764] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(448),
  [767] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(449),
  [770] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(451),
  [773] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(454),
  [776] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(455),
  [779] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(456),
  [782] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(461),
  [785] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(465),
  [788] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(466),
  [791] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(467),
  [794] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(469),
  [797] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(470),
  [800] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(595),
  [803] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(18),
  [806] = {.entry = {.count = 1, .reusable = true}}, SHIFT(815),
  [808] = {.entry = {.count = 1, .reusable = true}}, SHIFT(27),
  [810] = {.entry = {.count = 1, .reusable = true}}, SHIFT(709),
  [812] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_host_declaration, 7, .production_id = 68),
  [814] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_host_declaration, 7, .production_id = 68),
  ...
  [820] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_host_declaration, 6, .production_id = 30),
  [822] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_host_declaration, 6, .production_id = 30),
  [824] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_host_declaration, 5, .production_id = 17),
  [826] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_host_declaration, 5, .production_id = 17),
  [828] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 4),
  [830] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__declarations_repeat1, 4),
  [832] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_host_declaration, 8, .production_id = 68),
  [834] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_host_declaration, 8, .production_id = 68),
  [836] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_match_declaration, 7, .production_id = 18),
  [838] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_match_declaration, 7, .production_id = 18),
  [840] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_config_repeat1, 2),
  [842] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_match_declaration, 6, .production_id = 18),
  [844] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_match_declaration, 6, .production_id = 18),
  ...
  [850] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_host_declaration, 7, .production_id = 32),
  [852] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_host_declaration, 7, .production_id = 32),
  [854] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_match_declaration, 5, .production_id = 18),
  [856] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_match_declaration, 5, .production_id = 18),
  [858] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_config_repeat1, 3),
  [860] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_config_repeat1, 3),
  [862] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_host_declaration, 6, .production_id = 32),
  [864] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_host_declaration, 6, .production_id = 32),
  [866] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 3),
  [868] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__declarations_repeat1, 3),
  [870] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_host_declaration, 7, .production_id = 30),
  [872] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_host_declaration, 7, .production_id = 30),
  ...
  [906] = {.entry = {.count = 1, .reusable = true}}, SHIFT(826),
  [908] = {.entry = {.count = 1, .reusable = false}}, SHIFT(155),
  [910] = {.entry = {.count = 1, .reusable = false}}, SHIFT(608),
  [912] = {.entry = {.count = 1, .reusable = true}}, SHIFT(633),
  [914] = {.entry = {.count = 1, .reusable = false}}, SHIFT(204),
  [916] = {.entry = {.count = 1, .reusable = true}}, SHIFT(198),
  [918] = {.entry = {.count = 1, .reusable = true}}, SHIFT(830),
  [920] = {.entry = {.count = 1, .reusable = true}}, SHIFT(45),
  [922] = {.entry = {.count = 1, .reusable = false}}, SHIFT(161),
  [924] = {.entry = {.count = 1, .reusable = true}}, SHIFT(123),
  [926] = {.entry = {.count = 1, .reusable = true}}, SHIFT(717),
  [928] = {.entry = {.count = 1, .reusable = false}}, SHIFT(784),
  [930] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__file_pattern_vars_repeat1, 2), SHIFT_REPEAT(87),
  [933] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__file_pattern_vars_repeat1, 2), SHIFT_REPEAT(87),
  [936] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__file_pattern_vars_repeat1, 2), SHIFT_REPEAT(777),
  [939] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__file_pattern_vars_repeat1, 2),
  [941] = {.entry = {.count = 1, .reusable = false}}, SHIFT(87),
  [943] = {.entry = {.count = 1, .reusable = true}}, SHIFT(58),
  [945] = {.entry = {.count = 1, .reusable = true}}, SHIFT(87),
  [947] = {.entry = {.count = 1, .reusable = true}}, SHIFT(777),
  [949] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__file_pattern_vars, 1, .production_id = 11),
  [951] = {.entry = {.count = 1, .reusable = true}}, SHIFT(699),
  [953] = {.entry = {.count = 1, .reusable = true}}, SHIFT(641),
  [955] = {.entry = {.count = 1, .reusable = false}}, SHIFT(134),
  [957] = {.entry = {.count = 1, .reusable = true}}, SHIFT(134),
  [959] = {.entry = {.count = 1, .reusable = true}}, SHIFT(829),
  [961] = {.entry = {.count = 1, .reusable = true}}, SHIFT(65),
  [963] = {.entry = {.count = 1, .reusable = false}}, SHIFT(323),
  [965] = {.entry = {.count = 1, .reusable = true}}, SHIFT(784),
  [967] = {.entry = {.count = 1, .reusable = true}}, SHIFT(733),
  [969] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__file_pattern_vars_repeat2, 2),
  [971] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__file_pattern_vars_repeat2, 2), SHIFT_REPEAT(134),
  [974] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__file_pattern_vars_repeat2, 2), SHIFT_REPEAT(134),
  [977] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__file_pattern_vars_repeat2, 2), SHIFT_REPEAT(829),
  [980] = {.entry = {.count = 1, .reusable = true}}, SHIFT(471),
  [982] = {.entry = {.count = 1, .reusable = false}}, SHIFT(147),
  [984] = {.entry = {.count = 1, .reusable = true}}, SHIFT(147),
  [986] = {.entry = {.count = 1, .reusable = true}}, SHIFT(827),
  [988] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__hosts_string, 1, .production_id = 16),
  [990] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__hosts_string, 1, .production_id = 16),
  [992] = {.entry = {.count = 1, .reusable = false}}, SHIFT(172),
  [994] = {.entry = {.count = 1, .reusable = true}}, SHIFT(172),
  [996] = {.entry = {.count = 1, .reusable = true}}, SHIFT(828),
  [998] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__remote_command, 3, .production_id = 27),
  [1000] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__remote_command, 3, .production_id = 27),
  ...
  [1018] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_value, 1, .production_id = 11),
  ...
  [1026] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__remote_command_repeat1, 2), SHIFT_REPEAT(172),
  [1029] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__remote_command_repeat1, 2), SHIFT_REPEAT(172),
  [1032] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__remote_command_repeat1, 2), SHIFT_REPEAT(828),
  [1035] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__remote_command_repeat1, 2),
  [1037] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__remote_command_repeat1, 2),
  [1039] = {.entry = {.count = 1, .reusable = false}}, SHIFT(163),
  [1041] = {.entry = {.count = 1, .reusable = true}}, SHIFT(163),
  [1043] = {.entry = {.count = 1, .reusable = true}}, SHIFT(773),
  [1045] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_value, 2, .production_id = 63),
  [1047] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__file_string, 1, .production_id = 16),
  [1049] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [1051] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__hosts_string_repeat1, 2), SHIFT_REPEAT(147),
  [1054] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__hosts_string_repeat1, 2), SHIFT_REPEAT(147),
  [1057] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__hosts_string_repeat1, 2), SHIFT_REPEAT(827),
  [1060] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__hosts_string_repeat1, 2),
  [1062] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__hosts_string_repeat1, 2),
  [1064] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__file_string_repeat1, 2), SHIFT_REPEAT(161),
  [1067] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__file_string_repeat1, 2), SHIFT_REPEAT(161),
  [1070] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__file_string_repeat1, 2), SHIFT_REPEAT(826),
  [1073] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__file_string_repeat1, 2),
  [1075] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__pattern, 1, .production_id = 11),
  [1077] = {.entry = {.count = 1, .reusable = true}}, SHIFT(659),
  [1079] = {.entry = {.count = 1, .reusable = false}}, SHIFT(198),
  ...
  [1087] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__file_string_repeat2, 2),
  [1089] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__file_string_repeat2, 2), SHIFT_REPEAT(198),
  [1092] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__file_string_repeat2, 2), SHIFT_REPEAT(198),
  [1095] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__file_string_repeat2, 2), SHIFT_REPEAT(830),
  [1098] = {.entry = {.count = 1, .reusable = true}}, SHIFT(707),
  [1100] = {.entry = {.count = 1, .reusable = true}}, SHIFT(710),
  [1102] = {.entry = {.count = 1, .reusable = true}}, SHIFT(84),
  [1104] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__match_value_repeat1, 2), SHIFT_REPEAT(139),
  [1107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__match_value_repeat1, 2),
  [1109] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__match_value_repeat1, 2), SHIFT_REPEAT(139),
  ...
  [1120] = {.entry = {.count = 1, .reusable = true}}, SHIFT(511),
  [1122] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_time, 1),
  [1124] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_variable, 3, .production_id = 49),
  [1126] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable, 3, .production_id = 49),
  [1128] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__file_pattern_vars_repeat1, 1),
  [1130] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__file_pattern_vars_repeat1, 1),
  [1132] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__match_value_repeat2, 3, .production_id = 75),
  [1134] = {.entry = {.count = 1, .reusable = true}}, SHIFT(751),
  [1136] = {.entry = {.count = 1, .reusable = false}}, SHIFT(149),
  [1138] = {.entry = {.count = 1, .reusable = true}}, SHIFT(177),
  [1140] = {.entry = {.count = 1, .reusable = true}}, SHIFT(149),
  [1142] = {.entry = {.count = 1, .reusable = true}}, SHIFT(764),
  ...
  [1150] = {.entry = {.count = 1, .reusable = false}}, SHIFT(216),
  [1152] = {.entry = {.count = 1, .reusable = true}}, SHIFT(215),
  [1154] = {.entry = {.count = 1, .reusable = true}}, SHIFT(216),
  [1156] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__file_string_repeat1, 1), REDUCE(aux_sym__string_repeat1, 1),
  [1159] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__string_repeat1, 1),
  [1161] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__file_string_repeat1, 1),
  [1163] = {.entry = {.count = 1, .reusable = false}}, SHIFT(186),
  [1165] = {.entry = {.count = 1, .reusable = true}}, SHIFT(186),
  [1167] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__proxy_string, 1, .production_id = 16),
  [1169] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__proxy_string, 1, .production_id = 16),
  [1171] = {.entry = {.count = 1, .reusable = false}}, SHIFT(220),
  [1173] = {.entry = {.count = 1, .reusable = true}}, SHIFT(220),
  [1175] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_exec, 3, .production_id = 42),
  [1177] = {.entry = {.count = 1, .reusable = true}}, SHIFT(654),
  [1179] = {.entry = {.count = 1, .reusable = true}}, SHIFT(754),
  [1181] = {.entry = {.count = 1, .reusable = false}}, SHIFT(754),
  [1183] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__send_env_value, 1, .production_id = 29),
  [1185] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__hostname_string, 1, .production_id = 16),
  [1187] = {.entry = {.count = 1, .reusable = true}}, SHIFT(666),
  [1189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__match_value_repeat4, 2, .production_id = 38),
  [1191] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__match_value_repeat1, 2), SHIFT_REPEAT(150),
  [1194] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__match_value_repeat1, 2), SHIFT_REPEAT(150),
  [1197] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__match_value_repeat4, 3, .production_id = 75),
  [1199] = {.entry = {.count = 1, .reusable = false}}, SHIFT(676),
  [1201] = {.entry = {.count = 1, .reusable = false}}, SHIFT(793),
  [1203] = {.entry = {.count = 1, .reusable = false}}, SHIFT(426),
  [1205] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__match_exec_repeat1, 2), SHIFT_REPEAT(220),
  [1208] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__match_exec_repeat1, 2), SHIFT_REPEAT(220),
  [1211] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__match_exec_repeat1, 2),
  [1213] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__send_env_value_repeat1, 2), SHIFT_REPEAT(160),
  [1216] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__send_env_value_repeat1, 2),
  [1218] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__send_env_value, 2, .production_id = 37),
  ...
  [1226] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__match_value_repeat3, 2),
  [1228] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__match_value_repeat3, 2), SHIFT_REPEAT(149),
  [1231] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__match_value_repeat3, 2), SHIFT_REPEAT(149),
  [1234] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__proxy_string_repeat1, 2), SHIFT_REPEAT(186),
  [1237] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__proxy_string_repeat1, 2), SHIFT_REPEAT(186),
  [1240] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__proxy_string_repeat1, 2),
  [1242] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__proxy_string_repeat1, 2),
  [1244] = {.entry = {.count = 1, .reusable = false}}, SHIFT(684),
  [1246] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__match_value_repeat1, 2), SHIFT_REPEAT(163),
  [1249] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__match_value_repeat1, 2), SHIFT_REPEAT(163),
  ...
  [1256] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__hostname_string_repeat1, 2), SHIFT_REPEAT(216),
  [1259] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__hostname_string_repeat1, 2), SHIFT_REPEAT(216),
  [1262] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__hostname_string_repeat1, 2),
  [1264] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__match_value_repeat1, 1),
  [1266] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__match_value_repeat1, 1),
  [1268] = {.entry = {.count = 1, .reusable = true}}, SHIFT(757),
  [1270] = {.entry = {.count = 1, .reusable = false}}, SHIFT(385),
  [1272] = {.entry = {.count = 1, .reusable = true}}, SHIFT(385),
  [1274] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__hostname_string_repeat2, 2),
  [1276] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__hostname_string_repeat2, 2), SHIFT_REPEAT(277),
  [1279] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__hostname_string_repeat2, 2), SHIFT_REPEAT(277),
  [1282] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__token_string_repeat1, 2), SHIFT_REPEAT(195),
  [1285] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__token_string_repeat1, 2), SHIFT_REPEAT(195),
  [1288] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__token_string_repeat1, 2),
  [1290] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__token_string_repeat1, 2),
  ...
  [1298] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__hosts_string_repeat1, 1),
  [1300] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__hosts_string_repeat1, 1),
  [1302] = {.entry = {.count = 1, .reusable = true}}, SHIFT(154),
  [1304] = {.entry = {.count = 1, .reusable = true}}, SHIFT(367),
  [1306] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__match_value_repeat3, 1),
  [1308] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__match_value_repeat3, 1),
  [1310] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__match_value_repeat3, 2), SHIFT_REPEAT(273),
  [1313] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__match_value_repeat3, 2), SHIFT_REPEAT(273),
  [1316] = {.entry = {.count = 1, .reusable = false}}, SHIFT(273),
  [1318] = {.entry = {.count = 1, .reusable = true}}, SHIFT(273),
  [1320] = {.entry = {.count = 1, .reusable = true}}, SHIFT(245),
  [1322] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__log_verbose_value_repeat1, 2), SHIFT_REPEAT(154),
  [1325] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__log_verbose_value_repeat1, 2),
  [1327] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_number, 1),
  [1329] = {.entry = {.count = 1, .reusable = false}}, SHIFT(195),
  [1331] = {.entry = {.count = 1, .reusable = true}}, SHIFT(195),
  [1333] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__token_string, 1, .production_id = 16),
  [1335] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__token_string, 1, .production_id = 16),
  [1337] = {.entry = {.count = 1, .reusable = true}}, SHIFT(266),
  [1339] = {.entry = {.count = 1, .reusable = true}}, SHIFT(339),
  [1341] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__send_env_value_repeat1, 1),
  [1343] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__file_string_repeat1, 1),
  [1345] = {.entry = {.count = 1, .reusable = true}}, SHIFT(221),
  [1347] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__match_value_repeat3, 2), SHIFT_REPEAT(193),
  [1350] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__match_value_repeat3, 2), SHIFT_REPEAT(193),
  [1353] = {.entry = {.count = 1, .reusable = false}}, SHIFT(634),
  [1355] = {.entry = {.count = 1, .reusable = false}}, SHIFT(797),
  ...
  [1365] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__match_exec_repeat2, 2),
  [1367] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__match_exec_repeat2, 2), SHIFT_REPEAT(385),
  [1370] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__match_exec_repeat2, 2), SHIFT_REPEAT(385),
  [1373] = {.entry = {.count = 1, .reusable = true}}, SHIFT(753),
  [1375] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__remote_command_repeat1, 1),
  [1377] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__remote_command_repeat1, 1),
  [1379] = {.entry = {.count = 1, .reusable = true}}, SHIFT(645),
  ...
  [1387] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__macs_repeat1, 2), SHIFT_REPEAT(808),
  [1390] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__macs_repeat1, 2),
  [1392] = {.entry = {.count = 1, .reusable = true}}, SHIFT(811),
  [1394] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__host_key_algorithms, 4, .production_id = 32),
  [1396] = {.entry = {.count = 1, .reusable = true}}, SHIFT(814),
  [1398] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__ciphers, 4, .production_id = 32),
  [1400] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__hostbased_accepted_algorithms, 4, .production_id = 32),
  [1402] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__pubkey_accepted_algorithms, 3, .production_id = 17),
  [1404] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__string_repeat1, 2), SHIFT_REPEAT(323),
  [1407] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__string_repeat1, 2),
  [1409] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__proxy_string_repeat1, 1),
  [1411] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__proxy_string_repeat1, 1),
  [1413] = {.entry = {.count = 1, .reusable = true}}, SHIFT(806),
  [1415] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__preferred_authentications, 3, .production_id = 17),
  [1417] = {.entry = {.count = 1, .reusable = true}}, SHIFT(808),
  [1419] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__macs, 3, .production_id = 17),
  [1421] = {.entry = {.count = 1, .reusable = true}}, SHIFT(153),
  [1423] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__log_verbose, 3, .production_id = 25),
  [1425] = {.entry = {.count = 1, .reusable = true}}, SHIFT(817),
  [1427] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__ca_signature_algorithms, 4, .production_id = 32),
  [1429] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__token_string_repeat1, 1),
  [1431] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__token_string_repeat1, 1),
  [1433] = {.entry = {.count = 1, .reusable = true}}, SHIFT(148),
  [1435] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__file_string_repeat2, 1),
  [1437] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__file_string_repeat2, 1),
  [1439] = {.entry = {.count = 1, .reusable = true}}, SHIFT(663),
  [1441] = {.entry = {.count = 1, .reusable = true}}, SHIFT(155),
  [1443] = {.entry = {.count = 1, .reusable = true}}, SHIFT(810),
  [1445] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__kex_algorithms, 4, .production_id = 32),
  [1447] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__kex_algorithms, 3, .production_id = 17),
  [1449] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__file_string_repeat2, 1), REDUCE(aux_sym__string_repeat2, 1),
  [1452] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__file_string_repeat2, 1), REDUCE(aux_sym__string_repeat2, 1),
  [1455] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__log_verbose, 4, .production_id = 35),
  [1457] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__cnames_map_repeat1, 2), SHIFT_REPEAT(98),
  [1460] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__cnames_map_repeat1, 2),
  [1462] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__macs, 4, .production_id = 32),
  [1464] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__preferred_authentications, 4, .production_id = 32),
  [1466] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__pubkey_accepted_algorithms, 4, .production_id = 32),
  [1468] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__pattern, 3, .production_id = 38),
  [1470] = {.entry = {.count = 1, .reusable = true}}, SHIFT(778),
  [1472] = {.entry = {.count = 1, .reusable = true}}, SHIFT(224),
  [1474] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__hostname_string_repeat1, 1),
  [1476] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__hostname_string_repeat1, 1),
  [1478] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__host_key_algorithms, 3, .production_id = 17),
  [1480] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__hostbased_accepted_algorithms, 3, .production_id = 17),
  [1482] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__match_exec_repeat1, 1),
  [1484] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__match_exec_repeat1, 1),
  [1486] = {.entry = {.count = 1, .reusable = true}}, SHIFT(724),
  [1488] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_localnetwork, 3, .production_id = 43),
  ...
  [1498] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__ciphers, 3, .production_id = 17),
  [1500] = {.entry = {.count = 1, .reusable = true}}, SHIFT(98),
  [1502] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__cnames_map, 3, .production_id = 48),
  [1504] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__ca_signature_algorithms, 5, .production_id = 45),
  [1506] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__ca_signature_algorithms, 3, .production_id = 17),
  [1508] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__ca_signature_algorithms_repeat1, 2), SHIFT_REPEAT(817),
  [1511] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__ca_signature_algorithms_repeat1, 2),
  [1513] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__ciphers, 5, .production_id = 45),
  [1515] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__ciphers_repeat1, 2), SHIFT_REPEAT(814),
  [1518] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__ciphers_repeat1, 2),
  [1520] = {.entry = {.count = 1, .reusable = true}}, SHIFT(323),
  [1522] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__string, 1, .production_id = 16),
  [1524] = {.entry = {.count = 1, .reusable = true}}, SHIFT(499),
  [1526] = {.entry = {.count = 1, .reusable = false}}, SHIFT(499),
  [1528] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_final, 1, .production_id = 12),
  [1530] = {.entry = {.count = 1, .reusable = true}}, SHIFT(664),
  [1532] = {.entry = {.count = 1, .reusable = false}}, SHIFT(664),
  [1534] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_canonical, 1, .production_id = 12),
  [1536] = {.entry = {.count = 1, .reusable = true}}, SHIFT(786),
  [1538] = {.entry = {.count = 1, .reusable = true}}, SHIFT(218),
  [1540] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__hostbased_accepted_algorithms, 5, .production_id = 45),
  [1542] = {.entry = {.count = 1, .reusable = true}}, SHIFT(787),
  [1544] = {.entry = {.count = 1, .reusable = true}}, SHIFT(217),
  [1546] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__hostbased_accepted_algorithms_repeat1, 2), SHIFT_REPEAT(811),
  [1549] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__hostbased_accepted_algorithms_repeat1, 2),
  [1551] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__host_key_algorithms, 5, .production_id = 45),
  [1553] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__kex_algorithms, 5, .production_id = 45),
  [1555] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__kex_algorithms_repeat1, 2), SHIFT_REPEAT(810),
  [1558] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__kex_algorithms_repeat1, 2),
  [1560] = {.entry = {.count = 1, .reusable = true}}, SHIFT(712),
  [1562] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__log_verbose_repeat1, 2, .production_id = 58), SHIFT_REPEAT(153),
  [1565] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__log_verbose_repeat1, 2, .production_id = 58),
  [1567] = {.entry = {.count = 1, .reusable = true}}, SHIFT(788),
  [1569] = {.entry = {.count = 1, .reusable = true}}, SHIFT(203),
  [1571] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__macs, 5, .production_id = 45),
  [1573] = {.entry = {.count = 1, .reusable = true}}, SHIFT(610),
  [1575] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__preferred_authentications_repeat1, 2), SHIFT_REPEAT(806),
  [1578] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__preferred_authentications_repeat1, 2),
  [1580] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__pubkey_accepted_algorithms, 5, .production_id = 45),
  ...
  [1588] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_localnetwork, 4, .production_id = 64),
  [1590] = {.entry = {.count = 1, .reusable = false}}, SHIFT(794),
  [1592] = {.entry = {.count = 1, .reusable = false}}, SHIFT(660),
  [1594] = {.entry = {.count = 1, .reusable = false}}, SHIFT(435),
  [1596] = {.entry = {.count = 1, .reusable = true}}, SHIFT(795),
  [1598] = {.entry = {.count = 1, .reusable = true}}, SHIFT(184),
  [1600] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__cnames_map, 4, .production_id = 65),
  [1602] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__cnames_map, 4, .production_id = 66),
  [1604] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_value, 3, .production_id = 63),
  [1606] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__match_value_repeat2, 2), SHIFT_REPEAT(158),
  [1609] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__match_value_repeat2, 2),
  [1611] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_localnetwork, 5, .production_id = 70),
  [1613] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__match_localnetwork_repeat1, 2), SHIFT_REPEAT(724),
  [1616] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__match_localnetwork_repeat1, 2),
  [1618] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__cnames_map, 5, .production_id = 71),
  [1620] = {.entry = {.count = 1, .reusable = true}}, SHIFT(618),
  [1622] = {.entry = {.count = 1, .reusable = true}}, SHIFT(761),
  [1624] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__hostname_string_repeat2, 1),
  [1626] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__hostname_string_repeat2, 1),
  ...
  [1634] = {.entry = {.count = 1, .reusable = false}}, SHIFT(36),
  [1636] = {.entry = {.count = 1, .reusable = true}}, SHIFT(626),
  [1638] = {.entry = {.count = 1, .reusable = true}}, SHIFT(200),
  [1640] = {.entry = {.count = 1, .reusable = false}}, SHIFT(200),
  [1642] = {.entry = {.count = 1, .reusable = true}}, SHIFT(81),
  [1644] = {.entry = {.count = 1, .reusable = false}}, SHIFT(81),
  [1646] = {.entry = {.count = 1, .reusable = true}}, SHIFT(622),
  [1648] = {.entry = {.count = 1, .reusable = true}}, SHIFT(404),
  [1650] = {.entry = {.count = 1, .reusable = false}}, SHIFT(404),
  [1652] = {.entry = {.count = 1, .reusable = true}}, SHIFT(677),
  [1654] = {.entry = {.count = 1, .reusable = true}}, SHIFT(468),
  [1656] = {.entry = {.count = 1, .reusable = true}}, SHIFT(653),
  [1658] = {.entry = {.count = 1, .reusable = true}}, SHIFT(441),
  [1660] = {.entry = {.count = 1, .reusable = true}}, SHIFT(613),
  [1662] = {.entry = {.count = 1, .reusable = true}}, SHIFT(402),
  [1664] = {.entry = {.count = 1, .reusable = false}}, SHIFT(402),
  [1666] = {.entry = {.count = 1, .reusable = true}}, SHIFT(131),
  [1668] = {.entry = {.count = 1, .reusable = false}}, SHIFT(131),
  [1670] = {.entry = {.count = 1, .reusable = true}}, SHIFT(601),
  [1672] = {.entry = {.count = 1, .reusable = true}}, SHIFT(728),
  [1674] = {.entry = {.count = 1, .reusable = true}}, SHIFT(678),
  ...
  [1682] = {.entry = {.count = 1, .reusable = false}}, SHIFT(128),
  [1684] = {.entry = {.count = 1, .reusable = true}}, SHIFT(276),
  [1686] = {.entry = {.count = 1, .reusable = false}}, SHIFT(276),
  [1688] = {.entry = {.count = 1, .reusable = true}}, SHIFT(680),
  [1690] = {.entry = {.count = 1, .reusable = true}}, SHIFT(401),
  [1692] = {.entry = {.count = 1, .reusable = false}}, SHIFT(401),
  [1694] = {.entry = {.count = 1, .reusable = true}}, SHIFT(711),
  [1696] = {.entry = {.count = 1, .reusable = true}}, SHIFT(61),
  [1698] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [1700] = {.entry = {.count = 1, .reusable = true}}, SHIFT(718),
  [1702] = {.entry = {.count = 1, .reusable = true}}, SHIFT(79),
  [1704] = {.entry = {.count = 1, .reusable = false}}, SHIFT(79),
  [1706] = {.entry = {.count = 1, .reusable = true}}, SHIFT(725),
  [1708] = {.entry = {.count = 1, .reusable = true}}, SHIFT(727),
  [1710] = {.entry = {.count = 1, .reusable = true}}, SHIFT(162),
  [1712] = {.entry = {.count = 1, .reusable = false}}, SHIFT(162),
  [1714] = {.entry = {.count = 1, .reusable = true}}, SHIFT(488),
  [1716] = {.entry = {.count = 1, .reusable = false}}, SHIFT(488),
  [1718] = {.entry = {.count = 1, .reusable = true}}, SHIFT(95),
  [1720] = {.entry = {.count = 1, .reusable = false}}, SHIFT(95),
  [1722] = {.entry = {.count = 1, .reusable = true}}, SHIFT(93),
  [1724] = {.entry = {.count = 1, .reusable = false}}, SHIFT(93),
  [1726] = {.entry = {.count = 1, .reusable = true}}, SHIFT(91),
  [1728] = {.entry = {.count = 1, .reusable = false}}, SHIFT(91),
  [1730] = {.entry = {.count = 1, .reusable = true}}, SHIFT(90),
  [1732] = {.entry = {.count = 1, .reusable = false}}, SHIFT(90),
  [1734] = {.entry = {.count = 1, .reusable = true}}, SHIFT(38),
  [1736] = {.entry = {.count = 1, .reusable = true}}, SHIFT(11),
  ...
  [1744] = {.entry = {.count = 1, .reusable = false}}, SHIFT(68),
  [1746] = {.entry = {.count = 1, .reusable = true}}, SHIFT(391),
  [1748] = {.entry = {.count = 1, .reusable = false}}, SHIFT(391),
  [1750] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__string_repeat1, 2), SHIFT_REPEAT(608),
  [1753] = {.entry = {.count = 1, .reusable = true}}, SHIFT(48),
  [1755] = {.entry = {.count = 1, .reusable = false}}, SHIFT(48),
  [1757] = {.entry = {.count = 1, .reusable = true}}, SHIFT(390),
  [1759] = {.entry = {.count = 1, .reusable = false}}, SHIFT(390),
  [1761] = {.entry = {.count = 1, .reusable = true}}, SHIFT(214),
  [1763] = {.entry = {.count = 1, .reusable = false}}, SHIFT(214),
  [1765] = {.entry = {.count = 1, .reusable = true}}, SHIFT(388),
  [1767] = {.entry = {.count = 1, .reusable = false}}, SHIFT(388),
  [1769] = {.entry = {.count = 1, .reusable = true}}, SHIFT(799),
  [1771] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_time, 8),
  [1773] = {.entry = {.count = 1, .reusable = true}}, SHIFT(386),
  [1775] = {.entry = {.count = 1, .reusable = false}}, SHIFT(386),
  [1777] = {.entry = {.count = 1, .reusable = true}}, SHIFT(796),
  [1779] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_time, 6),
  [1781] = {.entry = {.count = 1, .reusable = true}}, SHIFT(656),
  [1783] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__match_localnetwork_repeat1, 3),
  [1785] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__match_localnetwork_repeat2, 2),
  [1787] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__match_localnetwork_repeat2, 2), SHIFT_REPEAT(780),
  [1790] = {.entry = {.count = 1, .reusable = true}}, SHIFT(729),
  [1792] = {.entry = {.count = 1, .reusable = true}}, SHIFT(720),
  [1794] = {.entry = {.count = 1, .reusable = false}}, SHIFT(720),
  [1796] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__match_value_repeat4, 2),
  [1798] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__match_value_repeat4, 2), SHIFT_REPEAT(177),
  [1801] = {.entry = {.count = 1, .reusable = true}}, SHIFT(722),
  [1803] = {.entry = {.count = 1, .reusable = false}}, SHIFT(722),
  [1805] = {.entry = {.count = 1, .reusable = true}}, SHIFT(103),
  [1807] = {.entry = {.count = 1, .reusable = false}}, SHIFT(103),
  [1809] = {.entry = {.count = 1, .reusable = true}}, SHIFT(125),
  [1811] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__canonical_domains, 3, .production_id = 17),
  [1813] = {.entry = {.count = 1, .reusable = true}}, SHIFT(675),
  [1815] = {.entry = {.count = 1, .reusable = true}}, SHIFT(171),
  [1817] = {.entry = {.count = 1, .reusable = false}}, SHIFT(171),
  [1819] = {.entry = {.count = 1, .reusable = true}}, SHIFT(50),
  [1821] = {.entry = {.count = 1, .reusable = false}}, SHIFT(50),
  [1823] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__log_verbose_value, 5, .production_id = 72),
  [1825] = {.entry = {.count = 1, .reusable = true}}, SHIFT(682),
  [1827] = {.entry = {.count = 1, .reusable = true}}, SHIFT(75),
  [1829] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__canonicalize_permitted_cnames, 3, .production_id = 19),
  ...
  [1837] = {.entry = {.count = 1, .reusable = false}}, SHIFT(55),
  ...
  [1847] = {.entry = {.count = 1, .reusable = true}}, SHIFT(697),
  [1849] = {.entry = {.count = 1, .reusable = true}}, SHIFT(380),
  [1851] = {.entry = {.count = 1, .reusable = false}}, SHIFT(380),
  [1853] = {.entry = {.count = 1, .reusable = true}}, SHIFT(359),
  [1855] = {.entry = {.count = 1, .reusable = false}}, SHIFT(359),
  [1857] = {.entry = {.count = 1, .reusable = true}}, SHIFT(743),
  [1859] = {.entry = {.count = 1, .reusable = true}}, SHIFT(726),
  [1861] = {.entry = {.count = 1, .reusable = true}}, SHIFT(780),
  [1863] = {.entry = {.count = 1, .reusable = true}}, SHIFT(762),
  [1865] = {.entry = {.count = 1, .reusable = false}}, SHIFT(762),
  [1867] = {.entry = {.count = 1, .reusable = true}}, SHIFT(348),
  [1869] = {.entry = {.count = 1, .reusable = false}}, SHIFT(348),
  [1871] = {.entry = {.count = 1, .reusable = true}}, SHIFT(770),
  [1873] = {.entry = {.count = 1, .reusable = false}}, SHIFT(770),
  [1875] = {.entry = {.count = 1, .reusable = true}}, SHIFT(344),
  [1877] = {.entry = {.count = 1, .reusable = false}}, SHIFT(344),
  [1879] = {.entry = {.count = 1, .reusable = true}}, SHIFT(54),
  [1881] = {.entry = {.count = 1, .reusable = false}}, SHIFT(54),
  [1883] = {.entry = {.count = 1, .reusable = true}}, SHIFT(747),
  [1885] = {.entry = {.count = 1, .reusable = true}}, SHIFT(343),
  [1887] = {.entry = {.count = 1, .reusable = false}}, SHIFT(343),
  [1889] = {.entry = {.count = 1, .reusable = true}}, SHIFT(767),
  [1891] = {.entry = {.count = 1, .reusable = false}}, SHIFT(767),
  [1893] = {.entry = {.count = 1, .reusable = true}}, SHIFT(745),
  [1895] = {.entry = {.count = 1, .reusable = true}}, SHIFT(329),
  [1897] = {.entry = {.count = 1, .reusable = false}}, SHIFT(329),
  [1899] = {.entry = {.count = 1, .reusable = true}}, SHIFT(233),
  [1901] = {.entry = {.count = 1, .reusable = false}}, SHIFT(233),
  [1903] = {.entry = {.count = 1, .reusable = true}}, SHIFT(53),
  [1905] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__dynamic_forward, 3, .production_id = 21),
  [1907] = {.entry = {.count = 1, .reusable = true}}, SHIFT(293),
  [1909] = {.entry = {.count = 1, .reusable = false}}, SHIFT(293),
  [1911] = {.entry = {.count = 1, .reusable = true}}, SHIFT(305),
  [1913] = {.entry = {.count = 1, .reusable = false}}, SHIFT(305),
  [1915] = {.entry = {.count = 1, .reusable = true}}, SHIFT(236),
  [1917] = {.entry = {.count = 1, .reusable = false}}, SHIFT(236),
  [1919] = {.entry = {.count = 1, .reusable = true}}, SHIFT(304),
  [1921] = {.entry = {.count = 1, .reusable = false}}, SHIFT(304),
  [1923] = {.entry = {.count = 1, .reusable = true}}, SHIFT(338),
  [1925] = {.entry = {.count = 1, .reusable = true}}, SHIFT(238),
  [1927] = {.entry = {.count = 1, .reusable = false}}, SHIFT(238),
  [1929] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__log_verbose_repeat2, 2, .production_id = 58),
  [1931] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__log_verbose_repeat2, 2, .production_id = 58), SHIFT_REPEAT(170),
  ...
  [1940] = {.entry = {.count = 1, .reusable = false}}, SHIFT(97),
  [1942] = {.entry = {.count = 1, .reusable = true}}, SHIFT(801),
  [1944] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_time, 4),
  [1946] = {.entry = {.count = 1, .reusable = true}}, SHIFT(768),
  [1948] = {.entry = {.count = 1, .reusable = true}}, SHIFT(345),
  [1950] = {.entry = {.count = 1, .reusable = true}}, SHIFT(302),
  [1952] = {.entry = {.count = 1, .reusable = false}}, SHIFT(302),
  [1954] = {.entry = {.count = 1, .reusable = true}}, SHIFT(191),
  [1956] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__global_known_hosts_file, 3, .production_id = 17),
  [1958] = {.entry = {.count = 1, .reusable = true}}, SHIFT(46),
  [1960] = {.entry = {.count = 1, .reusable = false}}, SHIFT(46),
  [1962] = {.entry = {.count = 1, .reusable = true}}, SHIFT(73),
  [1964] = {.entry = {.count = 1, .reusable = false}}, SHIFT(73),
  [1966] = {.entry = {.count = 1, .reusable = true}}, SHIFT(140),
  [1968] = {.entry = {.count = 1, .reusable = false}}, SHIFT(140),
  [1970] = {.entry = {.count = 1, .reusable = true}}, SHIFT(746),
  [1972] = {.entry = {.count = 1, .reusable = true}}, SHIFT(760),
  [1974] = {.entry = {.count = 1, .reusable = true}}, SHIFT(135),
  [1976] = {.entry = {.count = 1, .reusable = false}}, SHIFT(135),
  [1978] = {.entry = {.count = 1, .reusable = true}}, SHIFT(246),
  [1980] = {.entry = {.count = 1, .reusable = false}}, SHIFT(246),
  [1982] = {.entry = {.count = 1, .reusable = true}}, SHIFT(300),
  [1984] = {.entry = {.count = 1, .reusable = false}}, SHIFT(300),
  [1986] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__match_exec_repeat2, 1),
  [1988] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__match_exec_repeat2, 1),
  [1990] = {.entry = {.count = 1, .reusable = true}}, SHIFT(758),
  [1992] = {.entry = {.count = 1, .reusable = true}}, SHIFT(248),
  [1994] = {.entry = {.count = 1, .reusable = false}}, SHIFT(248),
  [1996] = {.entry = {.count = 1, .reusable = true}}, SHIFT(759),
  [1998] = {.entry = {.count = 1, .reusable = true}}, SHIFT(82),
  [2000] = {.entry = {.count = 1, .reusable = false}}, SHIFT(82),
  ...
  [2008] = {.entry = {.count = 1, .reusable = true}}, SHIFT(250),
  [2010] = {.entry = {.count = 1, .reusable = false}}, SHIFT(250),
  [2012] = {.entry = {.count = 1, .reusable = true}}, SHIFT(41),
  [2014] = {.entry = {.count = 1, .reusable = false}}, SHIFT(41),
  [2016] = {.entry = {.count = 1, .reusable = true}}, SHIFT(812),
  [2018] = {.entry = {.count = 1, .reusable = false}}, SHIFT(812),
  [2020] = {.entry = {.count = 1, .reusable = true}}, SHIFT(121),
  [2022] = {.entry = {.count = 1, .reusable = false}}, SHIFT(121),
  [2024] = {.entry = {.count = 1, .reusable = true}}, SHIFT(141),
  [2026] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__ignore_unknown, 3, .production_id = 17),
  [2028] = {.entry = {.count = 1, .reusable = true}}, SHIFT(254),
  [2030] = {.entry = {.count = 1, .reusable = false}}, SHIFT(254),
  [2032] = {.entry = {.count = 1, .reusable = true}}, SHIFT(298),
  [2034] = {.entry = {.count = 1, .reusable = false}}, SHIFT(298),
  [2036] = {.entry = {.count = 1, .reusable = true}}, SHIFT(526),
  [2038] = {.entry = {.count = 1, .reusable = false}}, SHIFT(526),
  [2040] = {.entry = {.count = 1, .reusable = true}}, SHIFT(294),
  [2042] = {.entry = {.count = 1, .reusable = false}}, SHIFT(294),
  [2044] = {.entry = {.count = 1, .reusable = true}}, SHIFT(763),
  [2046] = {.entry = {.count = 1, .reusable = true}}, SHIFT(738),
  [2048] = {.entry = {.count = 1, .reusable = true}}, SHIFT(286),
  [2050] = {.entry = {.count = 1, .reusable = false}}, SHIFT(286),
  [2052] = {.entry = {.count = 1, .reusable = true}}, SHIFT(723),
  [2054] = {.entry = {.count = 1, .reusable = false}}, SHIFT(723),
  [2056] = {.entry = {.count = 1, .reusable = true}}, SHIFT(114),
  [2058] = {.entry = {.count = 1, .reusable = false}}, SHIFT(114),
  [2060] = {.entry = {.count = 1, .reusable = true}}, SHIFT(259),
  [2062] = {.entry = {.count = 1, .reusable = false}}, SHIFT(259),
  [2064] = {.entry = {.count = 1, .reusable = true}}, SHIFT(517),
  [2066] = {.entry = {.count = 1, .reusable = false}}, SHIFT(517),
  [2068] = {.entry = {.count = 1, .reusable = true}}, SHIFT(78),
  [2070] = {.entry = {.count = 1, .reusable = false}}, SHIFT(78),
  [2072] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__user_known_hosts_file_repeat1, 2, .production_id = 40), SHIFT_REPEAT(51),
  [2075] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__user_known_hosts_file_repeat1, 2, .production_id = 40),
  [2077] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__set_env_repeat1, 2, .production_id = 40), SHIFT_REPEAT(581),
  [2080] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__set_env_repeat1, 2, .production_id = 40),
  [2082] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__send_env_repeat1, 2, .production_id = 40), SHIFT_REPEAT(96),
  [2085] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__send_env_repeat1, 2, .production_id = 40),
  [2087] = {.entry = {.count = 1, .reusable = true}}, SHIFT(109),
  [2089] = {.entry = {.count = 1, .reusable = false}}, SHIFT(109),
  [2091] = {.entry = {.count = 1, .reusable = true}}, SHIFT(742),
  [2093] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__proxy_jump, 5, .production_id = 45),
  [2095] = {.entry = {.count = 1, .reusable = true}}, SHIFT(261),
  [2097] = {.entry = {.count = 1, .reusable = false}}, SHIFT(261),
  [2099] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__permit_remote_open_repeat1, 2, .production_id = 61), SHIFT_REPEAT(126),
  [2102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__permit_remote_open_repeat1, 2, .production_id = 61),
  [2104] = {.entry = {.count = 1, .reusable = true}}, SHIFT(783),
  [2106] = {.entry = {.count = 1, .reusable = true}}, SHIFT(278),
  [2108] = {.entry = {.count = 1, .reusable = false}}, SHIFT(278),
  [2110] = {.entry = {.count = 1, .reusable = true}}, SHIFT(262),
  [2112] = {.entry = {.count = 1, .reusable = false}}, SHIFT(262),
  [2114] = {.entry = {.count = 1, .reusable = true}}, SHIFT(102),
  [2116] = {.entry = {.count = 1, .reusable = false}}, SHIFT(102),
  [2118] = {.entry = {.count = 1, .reusable = true}}, SHIFT(288),
  [2120] = {.entry = {.count = 1, .reusable = false}}, SHIFT(288),
  [2122] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__log_verbose_repeat1, 2, .production_id = 57),
  [2124] = {.entry = {.count = 1, .reusable = true}}, SHIFT(118),
  [2126] = {.entry = {.count = 1, .reusable = false}}, SHIFT(118),
  [2128] = {.entry = {.count = 1, .reusable = true}}, SHIFT(737),
  [2130] = {.entry = {.count = 1, .reusable = true}}, SHIFT(170),
  [2132] = {.entry = {.count = 1, .reusable = true}}, SHIFT(126),
  [2134] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__permit_remote_open, 3, .production_id = 26),
  [2136] = {.entry = {.count = 1, .reusable = true}}, SHIFT(40),
  [2138] = {.entry = {.count = 1, .reusable = false}}, SHIFT(40),
  [2140] = {.entry = {.count = 1, .reusable = true}}, SHIFT(173),
  [2142] = {.entry = {.count = 1, .reusable = false}}, SHIFT(173),
  [2144] = {.entry = {.count = 1, .reusable = true}}, SHIFT(507),
  [2146] = {.entry = {.count = 1, .reusable = false}}, SHIFT(507),
  [2148] = {.entry = {.count = 1, .reusable = true}}, SHIFT(64),
  [2150] = {.entry = {.count = 1, .reusable = false}}, SHIFT(64),
  [2152] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__ignore_unknown_repeat1, 2), SHIFT_REPEAT(141),
  [2155] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__ignore_unknown_repeat1, 2),
  [2157] = {.entry = {.count = 1, .reusable = true}}, SHIFT(107),
  [2159] = {.entry = {.count = 1, .reusable = false}}, SHIFT(107),
  [2161] = {.entry = {.count = 1, .reusable = true}}, SHIFT(108),
  [2163] = {.entry = {.count = 1, .reusable = false}}, SHIFT(108),
  [2165] = {.entry = {.count = 1, .reusable = true}}, SHIFT(569),
  [2167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__proxy_jump, 3, .production_id = 17),
  [2169] = {.entry = {.count = 1, .reusable = true}}, SHIFT(521),
  [2171] = {.entry = {.count = 1, .reusable = false}}, SHIFT(521),
  [2173] = {.entry = {.count = 1, .reusable = true}}, SHIFT(553),
  [2175] = {.entry = {.count = 1, .reusable = false}}, SHIFT(553),
  [2177] = {.entry = {.count = 1, .reusable = true}}, SHIFT(166),
  [2179] = {.entry = {.count = 1, .reusable = false}}, SHIFT(166),
  [2181] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__global_known_hosts_file_repeat1, 2, .production_id = 40), SHIFT_REPEAT(191),
  [2184] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__global_known_hosts_file_repeat1, 2, .production_id = 40),
  [2186] = {.entry = {.count = 1, .reusable = true}}, SHIFT(572),
  [2188] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bytes, 1),
  [2190] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__dynamic_forward_repeat1, 2, .production_id = 53), SHIFT_REPEAT(53),
  [2193] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__dynamic_forward_repeat1, 2, .production_id = 53),
  [2195] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__forward_value_inner, 3, .production_id = 51),
  [2197] = {.entry = {.count = 1, .reusable = true}}, SHIFT(279),
  [2199] = {.entry = {.count = 1, .reusable = false}}, SHIFT(279),
  [2201] = {.entry = {.count = 1, .reusable = true}}, SHIFT(790),
  [2203] = {.entry = {.count = 1, .reusable = false}}, SHIFT(790),
  [2205] = {.entry = {.count = 1, .reusable = true}}, SHIFT(281),
  [2207] = {.entry = {.count = 1, .reusable = false}}, SHIFT(281),
  [2209] = {.entry = {.count = 1, .reusable = true}}, SHIFT(120),
  [2211] = {.entry = {.count = 1, .reusable = false}}, SHIFT(120),
  [2213] = {.entry = {.count = 1, .reusable = true}}, SHIFT(819),
  [2215] = {.entry = {.count = 1, .reusable = false}}, SHIFT(819),
  [2217] = {.entry = {.count = 1, .reusable = true}}, SHIFT(284),
  [2219] = {.entry = {.count = 1, .reusable = false}}, SHIFT(284),
  [2221] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__cnames_map_repeat1, 2), SHIFT_REPEAT(132),
  [2224] = {.entry = {.count = 1, .reusable = true}}, SHIFT(96),
  [2226] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__send_env, 3, .production_id = 17),
  [2228] = {.entry = {.count = 1, .reusable = true}}, SHIFT(272),
  [2230] = {.entry = {.count = 1, .reusable = false}}, SHIFT(272),
  [2232] = {.entry = {.count = 1, .reusable = true}}, SHIFT(176),
  [2234] = {.entry = {.count = 1, .reusable = false}}, SHIFT(176),
  [2236] = {.entry = {.count = 1, .reusable = true}}, SHIFT(287),
  [2238] = {.entry = {.count = 1, .reusable = false}}, SHIFT(287),
  [2240] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__canonicalize_permitted_cnames_repeat1, 2, .production_id = 47), SHIFT_REPEAT(75),
  [2243] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__canonicalize_permitted_cnames_repeat1, 2, .production_id = 47),
  [2245] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__canonical_domains_repeat1, 2, .production_id = 40), SHIFT_REPEAT(125),
  [2248] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__canonical_domains_repeat1, 2, .production_id = 40),
  [2250] = {.entry = {.count = 1, .reusable = true}}, SHIFT(581),
  [2252] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__set_env, 3, .production_id = 17),
  [2254] = {.entry = {.count = 1, .reusable = true}}, SHIFT(274),
  [2256] = {.entry = {.count = 1, .reusable = false}}, SHIFT(274),
  [2258] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__string_repeat2, 2),
  [2260] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__string_repeat2, 2), SHIFT_REPEAT(508),
  [2263] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__string, 3, .production_id = 44),
  [2265] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_match_declaration_repeat1, 2), SHIFT_REPEAT(39),
  [2268] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_match_declaration_repeat1, 2),
  [2270] = {.entry = {.count = 1, .reusable = true}}, SHIFT(289),
  [2272] = {.entry = {.count = 1, .reusable = false}}, SHIFT(289),
  [2274] = {.entry = {.count = 1, .reusable = true}}, SHIFT(57),
  [2276] = {.entry = {.count = 1, .reusable = false}}, SHIFT(57),
  [2278] = {.entry = {.count = 1, .reusable = true}}, SHIFT(251),
  [2280] = {.entry = {.count = 1, .reusable = false}}, SHIFT(251),
  [2282] = {.entry = {.count = 1, .reusable = true}}, SHIFT(475),
  [2284] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__tunnel_device, 3, .production_id = 17),
  [2286] = {.entry = {.count = 1, .reusable = true}}, SHIFT(292),
  [2288] = {.entry = {.count = 1, .reusable = false}}, SHIFT(292),
  [2290] = {.entry = {.count = 1, .reusable = true}}, SHIFT(257),
  [2292] = {.entry = {.count = 1, .reusable = false}}, SHIFT(257),
  [2294] = {.entry = {.count = 1, .reusable = true}}, SHIFT(51),
  [2296] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__user_known_hosts_file, 3, .production_id = 17),
  [2298] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_host_declaration_repeat1, 2, .production_id = 40), SHIFT_REPEAT(85),
  [2301] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_host_declaration_repeat1, 2, .production_id = 40),
  [2303] = {.entry = {.count = 1, .reusable = true}}, SHIFT(71),
  [2305] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [2307] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__user_known_hosts_file, 4, .production_id = 30),
  [2309] = {.entry = {.count = 1, .reusable = true}}, SHIFT(698),
  [2311] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__set_env, 4, .production_id = 30),
  [2313] = {.entry = {.count = 1, .reusable = true}}, SHIFT(66),
  [2315] = {.entry = {.count = 1, .reusable = true}}, SHIFT(17),
  [2317] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__send_env, 4, .production_id = 30),
  [2319] = {.entry = {.count = 1, .reusable = true}}, SHIFT(821),
  [2321] = {.entry = {.count = 1, .reusable = false}}, SHIFT(821),
  [2323] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__permit_remote_open, 4, .production_id = 36),
  [2325] = {.entry = {.count = 1, .reusable = true}}, SHIFT(683),
  [2327] = {.entry = {.count = 1, .reusable = true}}, SHIFT(63),
  [2329] = {.entry = {.count = 1, .reusable = true}}, SHIFT(15),
  [2331] = {.entry = {.count = 1, .reusable = true}}, SHIFT(672),
  [2333] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__ignore_unknown, 4, .production_id = 32),
  [2335] = {.entry = {.count = 1, .reusable = true}}, SHIFT(463),
  [2337] = {.entry = {.count = 1, .reusable = true}}, SHIFT(508),
  [2339] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__canonicalize_permitted_cnames, 4, .production_id = 31),
  [2341] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__dynamic_forward, 4, .production_id = 33),
  [2343] = {.entry = {.count = 1, .reusable = false}}, SHIFT(802),
  [2345] = {.entry = {.count = 1, .reusable = false}}, SHIFT(800),
  [2347] = {.entry = {.count = 1, .reusable = false}}, SHIFT(222),
  [2349] = {.entry = {.count = 1, .reusable = true}}, SHIFT(223),
  [2351] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_time, 2),
  [2353] = {.entry = {.count = 1, .reusable = true}}, SHIFT(460),
  [2355] = {.entry = {.count = 1, .reusable = true}}, SHIFT(628),
  [2357] = {.entry = {.count = 1, .reusable = true}}, SHIFT(798),
  [2359] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__global_known_hosts_file, 4, .production_id = 30),
  [2361] = {.entry = {.count = 1, .reusable = true}}, SHIFT(138),
  [2363] = {.entry = {.count = 1, .reusable = true}}, SHIFT(37),
  [2365] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__canonical_domains, 4, .production_id = 30),
  [2367] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 1, .production_id = 1),
  [2369] = {.entry = {.count = 1, .reusable = true}}, SHIFT(607),
  [2371] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 1, .production_id = 5),
  [2373] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__string_repeat2, 1),
  [2375] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 1, .production_id = 8),
  [2377] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 1, .production_id = 7),
  [2379] = {.entry = {.count = 1, .reusable = true}}, SHIFT(804),
  [2381] = {.entry = {.count = 1, .reusable = true}}, SHIFT(32),
  [2383] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 1, .production_id = 6),
  [2385] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__var_value, 2, .production_id = 34),
  [2387] = {.entry = {.count = 1, .reusable = true}}, SHIFT(818),
  [2389] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 1, .production_id = 4),
  [2391] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition, 1, .production_id = 13),
  [2393] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition, 1, .production_id = 14),
  [2395] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__forward_value1, 1, .production_id = 24),
  [2397] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 1, .production_id = 3),
  [2399] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bytes, 2),
  [2401] = {.entry = {.count = 1, .reusable = true}}, SHIFT(797),
  [2403] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__xauth_location, 3, .production_id = 17),
  [2405] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 1, .production_id = 2),
  [2407] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_host_declaration_repeat1, 2, .production_id = 39),
  [2409] = {.entry = {.count = 1, .reusable = true}}, SHIFT(789),
  [2411] = {.entry = {.count = 1, .reusable = true}}, SHIFT(19),
  [2413] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__visual_host_key, 3, .production_id = 17),
  [2415] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_host, 3, .production_id = 41),
  [2417] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_canonical, 3, .production_id = 12),
  [2419] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_final, 3, .production_id = 12),
  [2421] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__string_repeat1, 1),
  [2423] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__verify_host_key_dns, 3, .production_id = 17),
  [2425] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_time, 10),
  [2427] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__use_keychain, 3, .production_id = 18),
  [2429] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_originalhost, 3, .production_id = 43),
  [2431] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_tagged, 3, .production_id = 43),
  [2433] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_user, 3, .production_id = 43),
  [2435] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_localuser, 3, .production_id = 43),
  [2437] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__update_host_keys, 3, .production_id = 17),
  [2439] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__tunnel, 3, .production_id = 17),
  [2441] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__tag, 3, .production_id = 17),
  [2443] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__tcp_keep_alive, 3, .production_id = 17),
  [2445] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__syslog_facility, 3, .production_id = 17),
  [2447] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__strict_host_key_checking, 3, .production_id = 17),
  [2449] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__add_keys_to_agent, 5, .production_id = 45),
  [2451] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__stream_local_bind_unlink, 3, .production_id = 17),
  [2453] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__stream_local_bind_mask, 3, .production_id = 17),
  [2455] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__canonical_domains_repeat1, 2, .production_id = 39),
  [2457] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__stdin_null, 3, .production_id = 17),
  [2459] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__canonicalize_permitted_cnames_repeat1, 2, .production_id = 46),
  [2461] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__session_type, 3, .production_id = 17),
  [2463] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__server_alive_interval, 3, .production_id = 17),
  [2465] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__server_alive_count_max, 3, .production_id = 17),
  [2467] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__security_key_provider, 3, .production_id = 17),
  [2469] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__file_pattern_vars, 3, .production_id = 38),
  [2471] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__security_key_provider, 3, .production_id = 23),
  [2473] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__revoked_host_keys, 3, .production_id = 17),
  [2475] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__required_rsa_size, 3, .production_id = 17),
  [2477] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__request_tty, 3, .production_id = 17),
  [2479] = {.entry = {.count = 1, .reusable = true}}, SHIFT(44),
  [2481] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__remote_forward, 3, .production_id = 28),
  [2483] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__dynamic_forward_value, 3, .production_id = 50),
  [2485] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__dynamic_forward_repeat1, 2, .production_id = 52),
  [2487] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__global_known_hosts_file_repeat1, 2, .production_id = 39),
  [2489] = {.entry = {.count = 1, .reusable = true}}, SHIFT(573),
  [2491] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__rekey_limit, 3, .production_id = 17),
  [2493] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__pubkey_authentication, 3, .production_id = 17),
  [2495] = {.entry = {.count = 1, .reusable = true}}, SHIFT(322),
  [2497] = {.entry = {.count = 1, .reusable = true}}, SHIFT(629),
  [2499] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__hostname_string, 3, .production_id = 44),
  [2501] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__proxy_use_fdpass, 3, .production_id = 17),
  [2503] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__file_string, 3, .production_id = 44),
  [2505] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__user, 3, .production_id = 15),
  [2507] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__ipqos, 5, .production_id = 54),
  [2509] = {.entry = {.count = 1, .reusable = true}}, SHIFT(606),
  [2511] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__proxy_command, 3, .production_id = 17),
  [2513] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__forward_value1, 3, .production_id = 50),
  [2515] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__forward_value2, 1, .production_id = 20),
  [2517] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__local_forward, 5, .production_id = 55),
  [2519] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__forward_value2, 1, .production_id = 24),
  [2521] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__log_verbose, 5, .production_id = 56),
  [2523] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__port, 3, .production_id = 17),
  [2525] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__pkcs11_provider, 3, .production_id = 17),
  [2527] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_value, 5, .production_id = 75),
  [2529] = {.entry = {.count = 1, .reusable = false}}, SHIFT(807),
  [2531] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__permit_local_command, 3, .production_id = 17),
  [2533] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__password_authentication, 3, .production_id = 17),
  [2535] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__number_of_password_prompts, 3, .production_id = 17),
  [2537] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__no_host_authentication_for_localhost, 3, .production_id = 17),
  [2539] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 1, .production_id = 9),
  [2541] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__log_verbose_quoted, 5, .production_id = 72),
  [2543] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__permit_remote_open_value, 3, .production_id = 59),
  [2545] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__permit_remote_open_repeat1, 2, .production_id = 60),
  [2547] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 1, .production_id = 10),
  [2549] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__log_level, 3, .production_id = 17),
  [2551] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__forward_value1, 1, .production_id = 22),
  [2553] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__rekey_limit, 5, .production_id = 54),
  [2555] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__remote_forward, 5, .production_id = 55),
  [2557] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__send_env_repeat1, 2, .production_id = 39),
  [2559] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__set_env_value, 3, .production_id = 29),
  [2561] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__set_env_repeat1, 2, .production_id = 39),
  [2563] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__tunnel_device, 5, .production_id = 45),
  [2565] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__user_known_hosts_file_repeat1, 2, .production_id = 39),
  [2567] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__forward_value1, 1, .production_id = 20),
  [2569] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__local_command, 3, .production_id = 17),
  [2571] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_host_declaration_repeat1, 3, .production_id = 62),
  [2573] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__add_keys_to_agent, 3, .production_id = 17),
  [2575] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__known_hosts_command, 3, .production_id = 17),
  [2577] = {.entry = {.count = 1, .reusable = true}}, SHIFT(782),
  [2579] = {.entry = {.count = 1, .reusable = true}}, SHIFT(34),
  [2581] = {.entry = {.count = 1, .reusable = true}}, SHIFT(510),
  [2583] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__kbd_interactive_authentication, 3, .production_id = 17),
  [2585] = {.entry = {.count = 1, .reusable = true}}, SHIFT(199),
  [2587] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__ipqos, 3, .production_id = 17),
  [2589] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__include, 3, .production_id = 17),
  [2591] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__identity_file, 3, .production_id = 17),
  [2593] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__identity_agent, 3, .production_id = 23),
  [2595] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__identity_agent, 3, .production_id = 17),
  [2597] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__identities_only, 3, .production_id = 17),
  [2599] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__hostname, 3, .production_id = 17),
  [2601] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__host_key_alias, 3, .production_id = 17),
  [2603] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__address_family, 3, .production_id = 17),
  [2605] = {.entry = {.count = 1, .reusable = false}}, SHIFT(779),
  [2607] = {.entry = {.count = 1, .reusable = false}}, SHIFT(349),
  [2609] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__hostbased_authentication, 3, .production_id = 17),
  [2611] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_localnetwork, 6, .production_id = 76),
  [2613] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__gssapi_delegate_credentials, 3, .production_id = 17),
  [2615] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__gssapi_authentication, 3, .production_id = 17),
  [2617] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__forward_x11_trusted, 3, .production_id = 17),
  [2619] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__forward_x11_timeout, 3, .production_id = 17),
  [2621] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__forward_x11, 3, .production_id = 17),
  [2623] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__forward_agent, 3, .production_id = 17),
  [2625] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__forward_agent, 3, .production_id = 23),
  [2627] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__log_verbose_repeat2, 2, .production_id = 57),
  [2629] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__log_verbose, 6, .production_id = 67),
  [2631] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__batch_mode, 3, .production_id = 17),
  [2633] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__fork_after_authentication, 3, .production_id = 17),
  [2635] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__fingerprint_hash, 3, .production_id = 17),
  [2637] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__bind_address, 3, .production_id = 17),
  [2639] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__exit_on_forward_failure, 3, .production_id = 17),
  [2641] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__escape_char, 3, .production_id = 17),
  [2643] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__enable_ssh_keysign, 3, .production_id = 17),
  [2645] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__enable_escape_command_line, 3, .production_id = 17),
  [2647] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_value, 4, .production_id = 38),
  [2649] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__dynamic_forward_value, 1, .production_id = 22),
  [2651] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__dynamic_forward_value, 1, .production_id = 20),
  [2653] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__bind_interface, 3, .production_id = 17),
  [2655] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_value, 3, .production_id = 38),
  [2657] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__control_path, 3, .production_id = 17),
  [2659] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__control_persist, 3, .production_id = 17),
  [2661] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__control_master, 3, .production_id = 17),
  [2663] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__connect_timeout, 3, .production_id = 17),
  [2665] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__connection_attempts, 3, .production_id = 17),
  [2667] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_exec, 5, .production_id = 69),
  [2669] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__compression, 3, .production_id = 17),
  [2671] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__clear_all_forwardings, 3, .production_id = 17),
  [2673] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__canonicalize_fallback_local, 3, .production_id = 17),
  [2675] = {.entry = {.count = 1, .reusable = true}}, SHIFT(744),
  [2677] = {.entry = {.count = 1, .reusable = false}}, SHIFT(744),
  [2679] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__canonicalize_hostname, 3, .production_id = 17),
  [2681] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_value, 4, .production_id = 75),
  [2683] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__check_host_ip, 3, .production_id = 17),
  [2685] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__certificate_file, 3, .production_id = 17),
  [2687] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__canonicalize_max_dots, 3, .production_id = 17),
  [2689] = {.entry = {.count = 1, .reusable = true}}, SHIFT(740),
  [2691] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__forward_value2, 3, .production_id = 50),
  [2693] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__proxy_jump, 7, .production_id = 74),
  [2695] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__canonicalize_permitted_cnames, 3, .production_id = 18),
  [2697] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__permit_remote_open_value, 5, .production_id = 73),
  [2699] = {.entry = {.count = 1, .reusable = true}},  ACCEPT_INPUT(),
  [2701] = {.entry = {.count = 1, .reusable = true}}, SHIFT(144),
  [2703] = {.entry = {.count = 1, .reusable = true}}, SHIFT(816),
  [2705] = {.entry = {.count = 1, .reusable = true}}, SHIFT(182),
  [2707] = {.entry = {.count = 1, .reusable = true}}, SHIFT(327),
  [2709] = {.entry = {.count = 1, .reusable = true}}, SHIFT(735),
  [2711] = {.entry = {.count = 1, .reusable = true}}, SHIFT(527),
  [2713] = {.entry = {.count = 1, .reusable = true}}, SHIFT(24),
  [2715] = {.entry = {.count = 1, .reusable = true}}, SHIFT(774),
  [2717] = {.entry = {.count = 1, .reusable = true}}, SHIFT(529),
  [2719] = {.entry = {.count = 1, .reusable = true}}, SHIFT(771),
  [2721] = {.entry = {.count = 1, .reusable = true}}, SHIFT(189),
  [2723] = {.entry = {.count = 1, .reusable = true}}, SHIFT(179),
  [2725] = {.entry = {.count = 1, .reusable = true}}, SHIFT(201),
  [2727] = {.entry = {.count = 1, .reusable = true}}, SHIFT(627),
  [2729] = {.entry = {.count = 1, .reusable = true}}, SHIFT(43),
  [2731] = {.entry = {.count = 1, .reusable = true}}, SHIFT(207),
  [2733] = {.entry = {.count = 1, .reusable = true}}, SHIFT(481),
  [2735] = {.entry = {.count = 1, .reusable = true}}, SHIFT(805),
  [2737] = {.entry = {.count = 1, .reusable = true}}, SHIFT(210),
  [2739] = {.entry = {.count = 1, .reusable = true}}, SHIFT(212),
  [2741] = {.entry = {.count = 1, .reusable = true}}, SHIFT(612),
  [2743] = {.entry = {.count = 1, .reusable = true}}, SHIFT(381),
  [2745] = {.entry = {.count = 1, .reusable = true}}, SHIFT(258),
  [2747] = {.entry = {.count = 1, .reusable = true}}, SHIFT(165),
  [2749] = {.entry = {.count = 1, .reusable = true}}, SHIFT(21),
  [2751] = {.entry = {.count = 1, .reusable = true}}, SHIFT(413),
  [2753] = {.entry = {.count = 1, .reusable = true}}, SHIFT(415),
  [2755] = {.entry = {.count = 1, .reusable = true}}, SHIFT(417),
  [2757] = {.entry = {.count = 1, .reusable = true}}, SHIFT(419),
  [2759] = {.entry = {.count = 1, .reusable = true}}, SHIFT(667),
  [2761] = {.entry = {.count = 1, .reusable = true}}, SHIFT(430),
  [2763] = {.entry = {.count = 1, .reusable = true}}, SHIFT(438),
  [2765] = {.entry = {.count = 1, .reusable = true}}, SHIFT(688),
  [2767] = {.entry = {.count = 1, .reusable = true}}, SHIFT(647),
  [2769] = {.entry = {.count = 1, .reusable = true}}, SHIFT(445),
  [2771] = {.entry = {.count = 1, .reusable = true}}, SHIFT(86),
  [2773] = {.entry = {.count = 1, .reusable = true}}, SHIFT(450),
  [2775] = {.entry = {.count = 1, .reusable = true}}, SHIFT(623),
  ...
  [2783] = {.entry = {.count = 1, .reusable = true}}, SHIFT(105),
  [2785] = {.entry = {.count = 1, .reusable = true}}, SHIFT(275),
  [2787] = {.entry = {.count = 1, .reusable = true}}, SHIFT(776),
  [2789] = {.entry = {.count = 1, .reusable = true}}, SHIFT(822),
  [2791] = {.entry = {.count = 1, .reusable = true}}, SHIFT(803),
  [2793] = {.entry = {.count = 1, .reusable = true}}, SHIFT(824),
  [2795] = {.entry = {.count = 1, .reusable = true}}, SHIFT(825),
};
