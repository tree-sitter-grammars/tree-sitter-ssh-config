...
enum {
  ...
  aux_sym__proxy_jump_value_token1 = 104,
  anon_sym_AT = 105,
  aux_sym__proxy_jump_value_token2 = 106,
  aux_sym__proxy_jump_value_token3 = 107,
  ...
  aux_sym__user_known_hosts_file_token1 = 148,
  aux_sym__verify_host_key_dns_token1 = 149,
  aux_sym__visual_host_key_token1 = 150,
  aux_sym__xauth_location_token1 = 151,
  sym_ipqos = 152,
  sym_verbosity = 153,
  sym_facility = 154,
  sym_authentication = 155,
  sym_cipher = 156,
  sym_kex = 157,
  sym_key_sig = 158,
  sym_mac = 159,
  sym_sig = 160,
  aux_sym__file_token_token1 = 161,
  aux_sym__hosts_token_token1 = 162,
  aux_sym__hostname_token_token1 = 163,
  aux_sym__proxy_token_token1 = 164,
  sym_token = 165,
  anon_sym_DOLLAR = 166,
  sym__var_name = 167,
  anon_sym_DOLLAR_LBRACE = 168,
  anon_sym_RBRACE = 169,
  anon_sym_yes = 170,
  anon_sym_no = 171,
  sym__number = 172,
  aux_sym_bytes_token1 = 173,
  aux_sym_time_token1 = 174,
  aux_sym_time_token2 = 175,
  aux_sym_time_token3 = 176,
  aux_sym_time_token4 = 177,
  aux_sym_time_token5 = 178,
  sym_comment = 179,
  aux_sym__sep_token1 = 180,
  sym__space = 181,
  sym__eol = 182,
  sym_config = 183,
  sym_host_declaration = 184,
  sym_match_declaration = 185,
  sym_condition = 186,
  sym__all = 187,
  sym__match_canonical = 188,
  sym__match_final = 189,
  sym__match_exec = 190,
  sym__match_localnetwork = 191,
  sym__match_host = 192,
  sym__match_originalhost = 193,
  sym__match_tagged = 194,
  sym__match_user = 195,
  sym__match_localuser = 196,
  sym__match_value = 197,
  sym__declarations = 198,
  sym_parameter = 199,
  sym__add_keys_to_agent = 200,
  sym__address_family = 201,
  sym__batch_mode = 202,
  sym__bind_address = 203,
  sym__bind_interface = 204,
  sym__canonical_domains = 205,
  sym__canonicalize_fallback_local = 206,
  sym__canonicalize_hostname = 207,
  sym__canonicalize_max_dots = 208,
  sym__canonicalize_permitted_cnames = 209,
  sym__cnames_map = 210,
  sym__ca_signature_algorithms = 211,
  sym__certificate_file = 212,
  sym__check_host_ip = 213,
  sym__ciphers = 214,
  sym__clear_all_forwardings = 215,
  sym__compression = 216,
  sym__connection_attempts = 217,
  sym__connect_timeout = 218,
  sym__control_master = 219,
  sym__control_persist = 220,
  sym__control_path = 221,
  sym__dynamic_forward = 222,
  sym__forward_value_inner = 223,
  sym__dynamic_forward_value = 224,
  sym__enable_escape_command_line = 225,
  sym__enable_ssh_keysign = 226,
  sym__escape_char = 227,
  sym__exit_on_forward_failure = 228,
  sym__fingerprint_hash = 229,
  sym__fork_after_authentication = 230,
  sym__forward_agent = 231,
  sym__forward_x11 = 232,
  sym__forward_x11_timeout = 233,
  sym__forward_x11_trusted = 234,
  sym__global_known_hosts_file = 235,
  sym__gssapi_authentication = 236,
  sym__gssapi_delegate_credentials = 237,
  sym__hostbased_accepted_algorithms = 238,
  sym__hostbased_authentication = 239,
  sym__host_key_algorithms = 240,
  sym__host_key_alias = 241,
  sym__hostname = 242,
  sym__identities_only = 243,
  sym__identity_agent = 244,
  sym__identity_file = 245,
  sym__ignore_unknown = 246,
  sym__include = 247,
  sym__ipqos = 248,
  sym__kbd_interactive_authentication = 249,
  sym__kex_algorithms = 250,
  sym__known_hosts_command = 251,
  sym__local_command = 252,
  sym__local_forward = 253,
  sym__forward_value1 = 254,
  sym__forward_value2 = 255,
  sym__log_level = 256,
  sym__log_verbose = 257,
  sym__log_verbose_value = 258,
  sym__log_verbose_quoted = 259,
  sym__macs = 260,
  sym__no_host_authentication_for_localhost = 261,
  sym__number_of_password_prompts = 262,
  sym__password_authentication = 263,
  sym__permit_local_command = 264,
  sym__permit_remote_open = 265,
  sym__permit_remote_open_value = 266,
  sym__pkcs11_provider = 267,
  sym__port = 268,
  sym__preferred_authentications = 269,
  sym__proxy_command = 270,
  sym__proxy_jump = 271,
  sym__proxy_jump_value = 272,
  sym__proxy_use_fdpass = 273,
  sym__pubkey_accepted_algorithms = 274,
  sym__pubkey_authentication = 275,
  sym__pubkey_authentication_arg = 276,
  sym__rekey_limit = 277,
  sym__remote_command = 278,
  sym__remote_forward = 279,
  sym__request_tty = 280,
  sym__required_rsa_size = 281,
  sym__revoked_host_keys = 282,
  sym__security_key_provider = 283,
  sym__send_env = 284,
  sym__send_env_value = 285,
  sym__server_alive_count_max = 286,
  sym__server_alive_interval = 287,
  sym__session_type = 288,
  sym__set_env = 289,
  sym__set_env_value = 290,
  sym__stdin_null = 291,
  sym__stream_local_bind_mask = 292,
  sym__stream_local_bind_unlink = 293,
  sym__strict_host_key_checking = 294,
  sym__syslog_facility = 295,
  sym__tcp_keep_alive = 296,
  sym__tag = 297,
  sym__tunnel = 298,
  sym__tunnel_device = 299,
  sym__update_host_keys = 300,
  sym__use_keychain = 301,
  sym__user = 302,
  sym__user_known_hosts_file = 303,
  sym__verify_host_key_dns = 304,
  sym__visual_host_key = 305,
  sym__xauth_location = 306,
  sym__file_token = 307,
  sym__hosts_token = 308,
  sym__hostname_token = 309,
  sym__proxy_token = 310,
  sym__var_value = 311,
  sym_variable = 312,
  sym__file_string = 313,
  sym__hosts_string = 314,
  sym__hostname_string = 315,
  sym__proxy_string = 316,
  sym__token_string = 317,
  sym__string = 318,
  sym__file_pattern_vars = 319,
  sym__pattern = 320,
  sym__boolean = 321,
  sym_number = 322,
  sym_bytes = 323,
  sym_time = 324,
  sym__sep = 325,
  aux_sym_config_repeat1 = 326,
  aux_sym_host_declaration_repeat1 = 327,
  aux_sym_match_declaration_repeat1 = 328,
  aux_sym__match_exec_repeat1 = 329,
  aux_sym__match_exec_repeat2 = 330,
  aux_sym__match_localnetwork_repeat1 = 331,
  aux_sym__match_localnetwork_repeat2 = 332,
  aux_sym__match_value_repeat1 = 333,
  aux_sym__match_value_repeat2 = 334,
  aux_sym__match_value_repeat3 = 335,
  aux_sym__match_value_repeat4 = 336,
  aux_sym__declarations_repeat1 = 337,
  aux_sym__canonical_domains_repeat1 = 338,
  aux_sym__canonicalize_permitted_cnames_repeat1 = 339,
  aux_sym__cnames_map_repeat1 = 340,
  aux_sym__ca_signature_algorithms_repeat1 = 341,
  aux_sym__ciphers_repeat1 = 342,
  aux_sym__dynamic_forward_repeat1 = 343,
  aux_sym__global_known_hosts_file_repeat1 = 344,
  aux_sym__hostbased_accepted_algorithms_repeat1 = 345,
  aux_sym__ignore_unknown_repeat1 = 346,
  aux_sym__kex_algorithms_repeat1 = 347,
  aux_sym__log_verbose_repeat1 = 348,
  aux_sym__log_verbose_repeat2 = 349,
  aux_sym__log_verbose_value_repeat1 = 350,
  aux_sym__macs_repeat1 = 351,
  aux_sym__permit_remote_open_repeat1 = 352,
  aux_sym__preferred_authentications_repeat1 = 353,
  aux_sym__proxy_jump_repeat1 = 354,
  aux_sym__remote_command_repeat1 = 355,
  aux_sym__send_env_repeat1 = 356,
  aux_sym__send_env_value_repeat1 = 357,
  aux_sym__set_env_repeat1 = 358,
  aux_sym__user_known_hosts_file_repeat1 = 359,
  aux_sym__file_string_repeat1 = 360,
  aux_sym__file_string_repeat2 = 361,
  aux_sym__hosts_string_repeat1 = 362,
  aux_sym__hostname_string_repeat1 = 363,
  aux_sym__hostname_string_repeat2 = 364,
  aux_sym__proxy_string_repeat1 = 365,
  aux_sym__token_string_repeat1 = 366,
  aux_sym__string_repeat1 = 367,
  aux_sym__string_repeat2 = 368,
  aux_sym__file_pattern_vars_repeat1 = 369,
  aux_sym__file_pattern_vars_repeat2 = 370,
  anon_alias_sym_User = 371,
  anon_alias_sym_host = 372,
  alias_sym_pattern = 373,
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 2:
      ...
      if (('1' <= lookahead && lookahead <= '9')) ADVANCE(2067);
      END_STATE();
    case 3:
      if (lookahead == '\n') ADVANCE(2078);
      if (lookahead == '\r') ADVANCE(1);
    ...
    case 14:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'z')) ADVANCE(2011);
      END_STATE();
    case 15:
      if (lookahead == '\n') ADVANCE(2078);
      if (lookahead == '\r') ADVANCE(1);
    ...
    case 16:
      ...
      if (lookahead == '\t' ||
          lookahead == ' ') ADVANCE(2077);
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(2070);
      if (lookahead == 'H' ||
          lookahead == 'h') ADVANCE(2071);
      if (lookahead == 'M' ||
          lookahead == 'm') ADVANCE(2072);
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2073);
      if (lookahead == 'W' ||
          lookahead == 'w') ADVANCE(2069);
      if (('1' <= lookahead && lookahead <= '9')) ADVANCE(2067);
      END_STATE();
    case 17:
      if (lookahead == '\n') ADVANCE(2078);
    ...
    case 122:
      ...
      END_STATE();
    case 123:
      if (lookahead == '1') ADVANCE(1835);
      if (lookahead == '2') ADVANCE(1835);
      if (lookahead == '3') ADVANCE(1835);
    ...
    case 209:
      ...
      END_STATE();
    case 210:
      if (lookahead == '6') ADVANCE(2047);
      END_STATE();
    case 211:
      if (lookahead == '6') ADVANCE(2046);
      END_STATE();
    case 212:
      if (lookahead == '6') ADVANCE(2053);
      END_STATE();
    case 213:
    ...
    case 224:
      ...
      END_STATE();
    case 225:
      if (lookahead == '9') ADVANCE(2049);
      END_STATE();
    case 226:
      if (lookahead == '9') ADVANCE(2053);
      END_STATE();
    case 227:
    ...
    case 1073:
      if (lookahead == 'F' ||
          lookahead == 'f') ADVANCE(1482);
      END_STATE();
    case 1074:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(2029);
      END_STATE();
    case 1075:
      if (lookahead == 'G' ||
    ...
    case 1212:
      ...
      if (lookahead == 'M' ||
          lookahead == 'm') ADVANCE(1416);
      if (lookahead == 'Q' ||
          lookahead == 'q') ADVANCE(1760);
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(1448);
      END_STATE();
    case 1213:
      if (lookahead == 'K' ||
    ...
    case 1240:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2013);
      END_STATE();
    case 1241:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(1902);
      END_STATE();
    case 1242:
      if (lookahead == 'L' ||
    ...
    case 1254:
      ...
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(978);
      END_STATE();
    case 1255:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(1279);
      END_STATE();
    case 1256:
      if (lookahead == 'L' ||
    ...
    case 1518:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(1579);
      END_STATE();
    case 1519:
      if (lookahead == 'Q' ||
          lookahead == 'q') ADVANCE(1418);
      END_STATE();
    case 1520:
      if (lookahead == 'R' ||
    ...
    case 1781:
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(2017);
      END_STATE();
    case 1782:
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(2010);
      END_STATE();
    case 1783:
      if (lookahead == 'V' ||
    ...
    case 1804:
      if (lookahead == 'X' ||
          lookahead == 'x') ADVANCE(2012);
      END_STATE();
    case 1805:
      if (lookahead == 'X' ||
          lookahead == 'x') ADVANCE(1809);
      END_STATE();
    case 1806:
      if (lookahead == 'X' ||
    ...
    case 1810:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(2005);
      END_STATE();
    case 1811:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(1893);
      END_STATE();
    case 1812:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(2038);
      END_STATE();
    case 1813:
      if (lookahead == 'Y' ||
    ...
    case 1829:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(1726);
      END_STATE();
    case 1830:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(1731);
      END_STATE();
    case 1831:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(1116);
      END_STATE();
    case 1832:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(1518);
      END_STATE();
    case 1833:
      if (lookahead == 'Z' ||
    ...
    case 1834:
      if (lookahead == 'Z' ||
          lookahead == 'z') ADVANCE(948);
      END_STATE();
    case 1835:
      if (('1' <= lookahead && lookahead <= '3')) ADVANCE(2040);
      END_STATE();
    case 1836:
      if (('0' <= lookahead && lookahead <= '7')) ADVANCE(2022);
      END_STATE();
    case 1837:
      if (('0' <= lookahead && lookahead <= '7')) ADVANCE(2021);
      END_STATE();
    case 1838:
      if (('0' <= lookahead && lookahead <= '7')) ADVANCE(2040);
      END_STATE();
    case 1839:
      if (('0' <= lookahead && lookahead <= '7')) ADVANCE(2043);
      END_STATE();
    case 1840:
    ...
    case 1842:
      if (('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'z')) ADVANCE(2061);
      END_STATE();
    case 1843:
      if (lookahead == '+' ||
          lookahead == '-' ||
    ...
    case 1847:
      ...
      if (('1' <= lookahead && lookahead <= '7')) ADVANCE(1841);
      END_STATE();
    case 1848:
    ...
    case 1863:
      ACCEPT_TOKEN(aux_sym__match_exec_token2);
      if (lookahead == '%' ||
          lookahead == 'h') ADVANCE(2056);
      END_STATE();
    case 1864:
      ACCEPT_TOKEN(aux_sym__match_exec_token2);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(2067);
      END_STATE();
    case 1865:
      ACCEPT_TOKEN(aux_sym__match_exec_token2);
      if (aux_sym__file_token_token1_character_set_1(lookahead)) ADVANCE(2054);
      END_STATE();
    case 1866:
    ...
    case 2002:
      ACCEPT_TOKEN(aux_sym__remote_command_token2);
      if (aux_sym__hosts_token_token1_character_set_1(lookahead)) ADVANCE(2055);
      END_STATE();
    case 2003:
      ACCEPT_TOKEN(aux_sym__remote_command_token2);
      if (sym_token_character_set_1(lookahead)) ADVANCE(2058);
      END_STATE();
    case 2004:
    ...
    case 2042:
      ACCEPT_TOKEN(sym_verbosity);
      if (('1' <= lookahead && lookahead <= '3')) ADVANCE(2041);
      END_STATE();
    case 2043:
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    [sym_config] = STATE(821),
    [sym_host_declaration] = STATE(3),
    [sym_match_declaration] = STATE(3),
    [sym_parameter] = STATE(506),
    [sym__add_keys_to_agent] = STATE(507),
    [sym__address_family] = STATE(509),
    [sym__batch_mode] = STATE(525),
    [sym__bind_address] = STATE(527),
    [sym__bind_interface] = STATE(531),
    [sym__canonical_domains] = STATE(534),
    [sym__canonicalize_fallback_local] = STATE(536),
    [sym__canonicalize_hostname] = STATE(544),
    [sym__canonicalize_max_dots] = STATE(545),
    [sym__canonicalize_permitted_cnames] = STATE(547),
    [sym__ca_signature_algorithms] = STATE(551),
    [sym__certificate_file] = STATE(557),
    [sym__check_host_ip] = STATE(558),
    [sym__ciphers] = STATE(561),
    [sym__clear_all_forwardings] = STATE(563),
    [sym__compression] = STATE(574),
    [sym__connection_attempts] = STATE(578),
    [sym__connect_timeout] = STATE(583),
    [sym__control_master] = STATE(616),
    [sym__control_persist] = STATE(617),
    [sym__control_path] = STATE(625),
    [sym__dynamic_forward] = STATE(657),
    [sym__enable_escape_command_line] = STATE(666),
    [sym__enable_ssh_keysign] = STATE(669),
    [sym__escape_char] = STATE(694),
    [sym__exit_on_forward_failure] = STATE(722),
    [sym__fingerprint_hash] = STATE(747),
    [sym__fork_after_authentication] = STATE(753),
    [sym__forward_agent] = STATE(769),
    [sym__forward_x11] = STATE(774),
    [sym__forward_x11_timeout] = STATE(773),
    [sym__forward_x11_trusted] = STATE(772),
    [sym__global_known_hosts_file] = STATE(771),
    [sym__gssapi_authentication] = STATE(770),
    [sym__gssapi_delegate_credentials] = STATE(767),
    [sym__hostbased_accepted_algorithms] = STATE(765),
    [sym__hostbased_authentication] = STATE(764),
    [sym__host_key_algorithms] = STATE(763),
    [sym__host_key_alias] = STATE(762),
    [sym__hostname] = STATE(760),
    [sym__identities_only] = STATE(758),
    [sym__identity_agent] = STATE(757),
    [sym__identity_file] = STATE(756),
    [sym__ignore_unknown] = STATE(755),
    [sym__include] = STATE(752),
    [sym__ipqos] = STATE(751),
    [sym__kbd_interactive_authentication] = STATE(750),
    [sym__kex_algorithms] = STATE(494),
    [sym__known_hosts_command] = STATE(745),
    [sym__local_command] = STATE(743),
    [sym__local_forward] = STATE(742),
    [sym__log_level] = STATE(741),
    [sym__log_verbose] = STATE(740),
    [sym__macs] = STATE(739),
    [sym__no_host_authentication_for_localhost] = STATE(738),
    [sym__number_of_password_prompts] = STATE(737),
    [sym__password_authentication] = STATE(735),
    [sym__permit_local_command] = STATE(734),
    [sym__permit_remote_open] = STATE(733),
    [sym__pkcs11_provider] = STATE(732),
    [sym__port] = STATE(731),
    [sym__preferred_authentications] = STATE(730),
    [sym__proxy_command] = STATE(729),
    [sym__proxy_jump] = STATE(728),
    [sym__proxy_use_fdpass] = STATE(727),
    [sym__pubkey_accepted_algorithms] = STATE(726),
    [sym__pubkey_authentication] = STATE(725),
    [sym__rekey_limit] = STATE(723),
    [sym__remote_command] = STATE(721),
    [sym__remote_forward] = STATE(719),
    [sym__request_tty] = STATE(718),
    [sym__required_rsa_size] = STATE(717),
    [sym__revoked_host_keys] = STATE(716),
    [sym__security_key_provider] = STATE(715),
    [sym__send_env] = STATE(712),
    [sym__server_alive_count_max] = STATE(709),
    [sym__server_alive_interval] = STATE(705),
    [sym__session_type] = STATE(704),
    [sym__set_env] = STATE(703),
    [sym__stdin_null] = STATE(702),
    [sym__stream_local_bind_mask] = STATE(701),
    [sym__stream_local_bind_unlink] = STATE(700),
    [sym__strict_host_key_checking] = STATE(699),
    [sym__syslog_facility] = STATE(698),
    [sym__tcp_keep_alive] = STATE(695),
    [sym__tag] = STATE(673),
    [sym__tunnel] = STATE(693),
    [sym__tunnel_device] = STATE(692),
    [sym__update_host_keys] = STATE(691),
    [sym__use_keychain] = STATE(690),
    [sym__user] = STATE(689),
    [sym__user_known_hosts_file] = STATE(688),
    [sym__verify_host_key_dns] = STATE(687),
    [sym__visual_host_key] = STATE(686),
    [sym__xauth_location] = STATE(681),
  ...
  [2] = {
    ...
    [aux_sym__pubkey_accepted_algorithms_token2] = ACTIONS(411),
    ...
    [aux_sym__set_env_token1] = ACTIONS(450),
    [aux_sym__stdin_null_token1] = ACTIONS(453),
    [aux_sym__stream_local_bind_mask_token1] = ACTIONS(456),
    [aux_sym__stream_local_bind_unlink_token1] = ACTIONS(459),
    [aux_sym__strict_host_key_checking_token1] = ACTIONS(462),
    [aux_sym__syslog_facility_token1] = ACTIONS(465),
    [aux_sym__tcp_keep_alive_token1] = ACTIONS(468),
    [aux_sym__tag_token1] = ACTIONS(471),
    [aux_sym__tunnel_token1] = ACTIONS(474),
    [aux_sym__tunnel_device_token1] = ACTIONS(477),
    [aux_sym__update_host_keys_token1] = ACTIONS(480),
    [aux_sym__use_keychain_token1] = ACTIONS(483),
    [aux_sym__user_known_hosts_file_token1] = ACTIONS(486),
    [aux_sym__verify_host_key_dns_token1] = ACTIONS(489),
    [aux_sym__visual_host_key_token1] = ACTIONS(492),
    [aux_sym__xauth_location_token1] = ACTIONS(495),
  ...
  [29] = {
    ...
    [aux_sym__pubkey_accepted_algorithms_token2] = ACTIONS(205),
    ...
    [aux_sym__set_env_token1] = ACTIONS(205),
    ...
    [aux_sym__use_keychain_token1] = ACTIONS(205),
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(151)] = 2412,
  [SMALL_STATE(152)] = 2422,
  [SMALL_STATE(153)] = 2438,
  [SMALL_STATE(154)] = 2452,
  [SMALL_STATE(155)] = 2466,
  [SMALL_STATE(156)] = 2482,
  [SMALL_STATE(157)] = 2498,
  [SMALL_STATE(158)] = 2510,
  [SMALL_STATE(159)] = 2520,
  [SMALL_STATE(160)] = 2536,
  [SMALL_STATE(161)] = 2546,
  [SMALL_STATE(162)] = 2556,
  ...
  [SMALL_STATE(185)] = 2814,
  [SMALL_STATE(186)] = 2825,
  [SMALL_STATE(187)] = 2836,
  [SMALL_STATE(188)] = 2845,
  [SMALL_STATE(189)] = 2856,
  [SMALL_STATE(190)] = 2867,
  [SMALL_STATE(191)] = 2878,
  [SMALL_STATE(192)] = 2889,
  [SMALL_STATE(193)] = 2900,
  [SMALL_STATE(194)] = 2911,
  [SMALL_STATE(195)] = 2922,
  [SMALL_STATE(196)] = 2933,
  [SMALL_STATE(197)] = 2946,
  [SMALL_STATE(198)] = 2957,
  [SMALL_STATE(199)] = 2964,
  [SMALL_STATE(200)] = 2971,
  [SMALL_STATE(201)] = 2982,
  [SMALL_STATE(202)] = 2991,
  [SMALL_STATE(203)] = 3004,
  [SMALL_STATE(204)] = 3015,
  [SMALL_STATE(205)] = 3024,
  [SMALL_STATE(206)] = 3035,
  [SMALL_STATE(207)] = 3046,
  [SMALL_STATE(208)] = 3057,
= {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(425),
  [673] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(424),
  [676] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(422),
  [679] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(421),
  [682] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(420),
  [685] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(419),
  [688] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(418),
  [691] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(417),
  [694] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(416),
  [697] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(415),
  [700] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(414),
  [703] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(413),
  [706] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(412),
  [709] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(411),
  [712] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(410),
  [715] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(409),
  [718] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(408),
  [721] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(407),
  [724] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(406),
  [727] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(405),
  [730] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(404),
  [733] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(402),
  [736] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(401),
  [739] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(400),
  [742] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(398),
  [745] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(397),
  [748] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(396),
  [751] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(395),
  [754] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(394),
  [757] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(393),
  [760] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(392),
  [763] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(391),
  [766] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(389),
  [769] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(388),
  [772] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(387),
  [775] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(386),
  [778] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(384),
  [781] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(383),
  [784] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(382),
  [787] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(381),
  [790] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(380),
  [793] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(378),
  [796] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(377),
  [799] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(376),
  [802] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(375),
  [805] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(374),
  [808] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(373),
  [811] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(371),
  [814] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(370),
  [817] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(354),
  [820] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(610),
  [823] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 2), SHIFT_REPEAT(18),
  [826] = {.entry = {.count = 1, .reusable = true}}, SHIFT(788),
  [828] = {.entry = {.count = 1, .reusable = true}}, SHIFT(29),
  [830] = {.entry = {.count = 1, .reusable = true}}, SHIFT(724),
  [832] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_host_declaration, 8, .production_id = 76),
  [834] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_host_declaration, 8, .production_id = 76),
  [836] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_host_declaration, 6, .production_id = 35),
  [838] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_host_declaration, 6, .production_id = 35),
  [840] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_config_repeat1, 4),
  [842] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_config_repeat1, 4),
  [844] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 4),
  [846] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__declarations_repeat1, 4),
  [848] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_host_declaration, 5, .production_id = 17),
  [850] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_host_declaration, 5, .production_id = 17),
  [852] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_config_repeat1, 3),
  [854] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_config_repeat1, 3),
  [856] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__declarations_repeat1, 3),
  [858] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__declarations_repeat1, 3),
  [860] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_match_declaration, 7, .production_id = 18),
  [862] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_match_declaration, 7, .production_id = 18),
  ...
  [870] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_host_declaration, 6, .production_id = 37),
  [872] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_host_declaration, 6, .production_id = 37),
  [874] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_host_declaration, 7, .production_id = 35),
  [876] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_host_declaration, 7, .production_id = 35),
  [878] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_host_declaration, 7, .production_id = 76),
  [880] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_host_declaration, 7, .production_id = 76),
  [882] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_host_declaration, 6, .production_id = 17),
  [884] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_host_declaration, 6, .production_id = 17),
  ...
  [920] = {.entry = {.count = 1, .reusable = true}}, SHIFT(826),
  [922] = {.entry = {.count = 1, .reusable = false}}, SHIFT(164),
  [924] = {.entry = {.count = 1, .reusable = false}}, SHIFT(572),
  ...
  [932] = {.entry = {.count = 1, .reusable = true}}, SHIFT(830),
  [934] = {.entry = {.count = 1, .reusable = true}}, SHIFT(43),
  [936] = {.entry = {.count = 1, .reusable = false}}, SHIFT(151),
  [938] = {.entry = {.count = 1, .reusable = true}}, SHIFT(91),
  [940] = {.entry = {.count = 1, .reusable = true}}, SHIFT(573),
  [942] = {.entry = {.count = 1, .reusable = false}}, SHIFT(795),
  ...
  [950] = {.entry = {.count = 1, .reusable = true}}, SHIFT(792),
  ...
  [958] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__file_pattern_vars_repeat1, 2), SHIFT_REPEAT(792),
  ...
  [965] = {.entry = {.count = 1, .reusable = true}}, SHIFT(714),
  [967] = {.entry = {.count = 1, .reusable = true}}, SHIFT(475),
  [969] = {.entry = {.count = 1, .reusable = false}}, SHIFT(326),
  [971] = {.entry = {.count = 1, .reusable = true}}, SHIFT(795),
  [973] = {.entry = {.count = 1, .reusable = true}}, SHIFT(591),
  [975] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__file_pattern_vars_repeat2, 2),
  [977] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__file_pattern_vars_repeat2, 2), SHIFT_REPEAT(123),
  [980] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__file_pattern_vars_repeat2, 2), SHIFT_REPEAT(123),
  [983] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__file_pattern_vars_repeat2, 2), SHIFT_REPEAT(829),
  ...
  [994] = {.entry = {.count = 1, .reusable = true}}, SHIFT(829),
  ...
  [1006] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__hosts_string_repeat1, 2), SHIFT_REPEAT(143),
  [1009] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__hosts_string_repeat1, 2), SHIFT_REPEAT(143),
  [1012] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__hosts_string_repeat1, 2), SHIFT_REPEAT(827),
  ...
  [1025] = {.entry = {.count = 1, .reusable = false}}, SHIFT(510),
  [1027] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__remote_command_repeat1, 2), SHIFT_REPEAT(167),
  [1030] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__remote_command_repeat1, 2), SHIFT_REPEAT(167),
  [1033] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__remote_command_repeat1, 2), SHIFT_REPEAT(828),
  [1036] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__remote_command_repeat1, 2),
  [1038] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__remote_command_repeat1, 2),
  [1040] = {.entry = {.count = 1, .reusable = false}}, SHIFT(143),
  [1042] = {.entry = {.count = 1, .reusable = true}}, SHIFT(143),
  [1044] = {.entry = {.count = 1, .reusable = true}}, SHIFT(827),
  [1046] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__hosts_string, 1, .production_id = 16),
  [1048] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__hosts_string, 1, .production_id = 16),
  [1050] = {.entry = {.count = 1, .reusable = false}}, SHIFT(167),
  [1052] = {.entry = {.count = 1, .reusable = true}}, SHIFT(167),
  [1054] = {.entry = {.count = 1, .reusable = true}}, SHIFT(828),
  [1056] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__remote_command, 3, .production_id = 30),
  [1058] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__remote_command, 3, .production_id = 30),
  [1060] = {.entry = {.count = 1, .reusable = false}}, SHIFT(117),
  [1062] = {.entry = {.count = 1, .reusable = true}}, SHIFT(206),
  [1064] = {.entry = {.count = 1, .reusable = true}}, SHIFT(117),
  [1066] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_value, 1, .production_id = 11),
  ...
  [1074] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__file_string_repeat1, 2), SHIFT_REPEAT(151),
  [1077] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__file_string_repeat1, 2), SHIFT_REPEAT(151),
  [1080] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__file_string_repeat1, 2), SHIFT_REPEAT(826),
  [1083] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__file_string_repeat1, 2),
  ...
  [1093] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_variable, 3, .production_id = 55),
  [1095] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable, 3, .production_id = 55),
  [1097] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__match_value_repeat2, 2, .production_id = 44),
  ...
  [1111] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__file_pattern_vars_repeat1, 1),
  [1113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__file_pattern_vars_repeat1, 1),
  ...
  [1123] = {.entry = {.count = 1, .reusable = true}}, SHIFT(518),
  [1125] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_time, 1),
  [1127] = {.entry = {.count = 1, .reusable = true}}, SHIFT(107),
  [1129] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__pattern, 1, .production_id = 11),
  [1131] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__match_value_repeat1, 2), SHIFT_REPEAT(117),
  [1134] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__match_value_repeat1, 2),
  [1136] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__match_value_repeat1, 2), SHIFT_REPEAT(117),
  [1139] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__file_string_repeat2, 2),
  [1141] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__file_string_repeat2, 2), SHIFT_REPEAT(249),
  [1144] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__file_string_repeat2, 2), SHIFT_REPEAT(249),
  [1147] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__file_string_repeat2, 2), SHIFT_REPEAT(830),
  [1150] = {.entry = {.count = 1, .reusable = true}}, SHIFT(606),
  [1152] = {.entry = {.count = 1, .reusable = false}}, SHIFT(606),
  [1154] = {.entry = {.count = 1, .reusable = true}}, SHIFT(521),
  [1156] = {.entry = {.count = 1, .reusable = false}}, SHIFT(243),
  [1158] = {.entry = {.count = 1, .reusable = true}}, SHIFT(243),
  [1160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__hostname_string, 1, .production_id = 16),
  ...
  [1168] = {.entry = {.count = 1, .reusable = false}}, SHIFT(697),
  [1170] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__match_value_repeat1, 2), SHIFT_REPEAT(158),
  [1173] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__match_value_repeat1, 2), SHIFT_REPEAT(158),
  [1176] = {.entry = {.count = 1, .reusable = true}}, SHIFT(244),
  [1178] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__proxy_string_repeat1, 2), SHIFT_REPEAT(222),
  [1181] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__proxy_string_repeat1, 2), SHIFT_REPEAT(222),
  [1184] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__proxy_string_repeat1, 2),
  [1186] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__proxy_string_repeat1, 2),
  [1188] = {.entry = {.count = 1, .reusable = true}}, SHIFT(171),
  [1190] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__send_env_value, 2, .production_id = 43),
  [1192] = {.entry = {.count = 1, .reusable = true}}, SHIFT(201),
  [1194] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__send_env_value_repeat1, 2), SHIFT_REPEAT(171),
  [1197] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__send_env_value_repeat1, 2),
  [1199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__send_env_value, 1, .production_id = 32),
  [1201] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__match_value_repeat3, 2),
  [1203] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__match_value_repeat3, 2), SHIFT_REPEAT(162),
  [1206] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__match_value_repeat3, 2), SHIFT_REPEAT(162),
  ...
  [1215] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__match_value_repeat1, 1),
  [1217] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__match_value_repeat1, 1),
  [1219] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__match_value_repeat1, 2), SHIFT_REPEAT(168),
  [1222] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__match_value_repeat1, 2), SHIFT_REPEAT(168),
  ...
  [1231] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__file_pattern_vars_repeat2, 1),
  [1233] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__file_pattern_vars_repeat2, 1),
  ...
  [1244] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__match_value_repeat4, 2, .production_id = 44),
  [1246] = {.entry = {.count = 1, .reusable = false}}, SHIFT(182),
  [1248] = {.entry = {.count = 1, .reusable = true}}, SHIFT(182),
  [1250] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_exec, 3, .production_id = 48),
  [1252] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__hostname_string_repeat1, 2), SHIFT_REPEAT(243),
  [1255] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__hostname_string_repeat1, 2), SHIFT_REPEAT(243),
  [1258] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__hostname_string_repeat1, 2),
  [1260] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__match_exec_repeat1, 2), SHIFT_REPEAT(182),
  [1263] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__match_exec_repeat1, 2), SHIFT_REPEAT(182),
  [1266] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__match_exec_repeat1, 2),
  ...
  [1272] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__match_value_repeat3, 2), SHIFT_REPEAT(230),
  [1275] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__match_value_repeat3, 2), SHIFT_REPEAT(230),
  [1278] = {.entry = {.count = 1, .reusable = false}}, SHIFT(204),
  [1280] = {.entry = {.count = 1, .reusable = true}}, SHIFT(204),
  [1282] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__token_string_repeat1, 2), SHIFT_REPEAT(268),
  [1285] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__token_string_repeat1, 2), SHIFT_REPEAT(268),
  ...
  [1292] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__hosts_string_repeat1, 1),
  [1294] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__hosts_string_repeat1, 1),
  [1296] = {.entry = {.count = 1, .reusable = true}}, SHIFT(197),
  [1298] = {.entry = {.count = 1, .reusable = true}}, SHIFT(538),
  [1300] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__match_exec_repeat2, 2),
  [1302] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__match_exec_repeat2, 2), SHIFT_REPEAT(341),
  [1305] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__match_exec_repeat2, 2), SHIFT_REPEAT(341),
  [1308] = {.entry = {.count = 1, .reusable = false}}, SHIFT(177),
  [1310] = {.entry = {.count = 1, .reusable = false}}, SHIFT(809),
  [1312] = {.entry = {.count = 1, .reusable = false}}, SHIFT(176),
  [1314] = {.entry = {.count = 1, .reusable = true}}, SHIFT(438),
  [1316] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__log_verbose_value_repeat1, 2), SHIFT_REPEAT(149),
  ...
  [1337] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__hostname_string_repeat2, 2),
  [1339] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__hostname_string_repeat2, 2), SHIFT_REPEAT(431),
  [1342] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__hostname_string_repeat2, 2), SHIFT_REPEAT(431),
  [1345] = {.entry = {.count = 1, .reusable = false}}, SHIFT(336),
  ...
  [1355] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__match_value_repeat3, 1),
  [1357] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__match_value_repeat3, 1),
  [1359] = {.entry = {.count = 1, .reusable = true}}, SHIFT(766),
  [1361] = {.entry = {.count = 1, .reusable = false}}, SHIFT(341),
  [1363] = {.entry = {.count = 1, .reusable = true}}, SHIFT(341),
  [1365] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_number, 1),
  [1367] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__match_value_repeat3, 2), SHIFT_REPEAT(204),
  [1370] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__match_value_repeat3, 2), SHIFT_REPEAT(204),
  [1373] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__remote_command_repeat1, 1),
  [1375] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__remote_command_repeat1, 1),
  [1377] = {.entry = {.count = 1, .reusable = true}}, SHIFT(516),
  [1379] = {.entry = {.count = 1, .reusable = false}}, SHIFT(268),
  [1381] = {.entry = {.count = 1, .reusable = true}}, SHIFT(268),
  [1383] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__token_string, 1, .production_id = 16),
  [1385] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__token_string, 1, .production_id = 16),
  [1387] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__send_env_value_repeat1, 1),
  [1389] = {.entry = {.count = 1, .reusable = true}}, SHIFT(350),
  [1391] = {.entry = {.count = 1, .reusable = true}}, SHIFT(108),
  [1393] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__cnames_map, 3, .production_id = 54),
  [1395] = {.entry = {.count = 1, .reusable = true}}, SHIFT(811),
  [1397] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__host_key_algorithms, 4, .production_id = 37),
  [1399] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__proxy_jump_value, 1, .production_id = 27),
  [1401] = {.entry = {.count = 1, .reusable = true}}, SHIFT(582),
  [1403] = {.entry = {.count = 1, .reusable = true}}, SHIFT(156),
  [1405] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__proxy_jump, 3, .production_id = 29),
  [1407] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__hostbased_accepted_algorithms, 4, .production_id = 37),
  [1409] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__pubkey_accepted_algorithms, 3, .production_id = 17),
  ...
  [1415] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__pubkey_accepted_algorithms, 5, .production_id = 51),
  [1417] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__proxy_jump_repeat1, 2, .production_id = 70), SHIFT_REPEAT(156),
  [1420] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__proxy_jump_repeat1, 2, .production_id = 70),
  [1422] = {.entry = {.count = 1, .reusable = true}}, SHIFT(781),
  [1424] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_localnetwork, 3, .production_id = 49),
  [1426] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__proxy_jump_value, 3, .production_id = 68),
  [1428] = {.entry = {.count = 1, .reusable = true}}, SHIFT(754),
  [1430] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__preferred_authentications_repeat1, 2), SHIFT_REPEAT(801),
  [1433] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__preferred_authentications_repeat1, 2),
  [1435] = {.entry = {.count = 1, .reusable = true}}, SHIFT(813),
  [1437] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__ciphers, 4, .production_id = 37),
  [1439] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__ciphers, 3, .production_id = 17),
  [1441] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__macs_repeat1, 2), SHIFT_REPEAT(803),
  [1444] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__macs_repeat1, 2),
  [1446] = {.entry = {.count = 1, .reusable = true}}, SHIFT(326),
  [1448] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__string, 1, .production_id = 16),
  [1450] = {.entry = {.count = 1, .reusable = true}}, SHIFT(803),
  [1452] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__macs, 5, .production_id = 51),
  [1454] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__log_verbose_repeat1, 2, .production_id = 64), SHIFT_REPEAT(147),
  [1457] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__log_verbose_repeat1, 2, .production_id = 64),
  ...
  [1467] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__cnames_map_repeat1, 2),
  [1469] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__pattern, 3, .production_id = 44),
  [1471] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__kex_algorithms_repeat1, 2), SHIFT_REPEAT(806),
  [1474] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__kex_algorithms_repeat1, 2),
  [1476] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__cnames_map, 5, .production_id = 79),
  [1478] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__match_localnetwork_repeat1, 2), SHIFT_REPEAT(781),
  [1481] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__match_localnetwork_repeat1, 2),
  [1483] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_value, 2, .production_id = 11),
  [1485] = {.entry = {.count = 1, .reusable = true}}, SHIFT(815),
  [1487] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__ca_signature_algorithms, 5, .production_id = 51),
  [1489] = {.entry = {.count = 1, .reusable = true}}, SHIFT(499),
  [1491] = {.entry = {.count = 1, .reusable = false}}, SHIFT(499),
  [1493] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_final, 1, .production_id = 12),
  [1495] = {.entry = {.count = 1, .reusable = true}}, SHIFT(498),
  [1497] = {.entry = {.count = 1, .reusable = false}}, SHIFT(498),
  [1499] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_canonical, 1, .production_id = 12),
  [1501] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__ca_signature_algorithms, 4, .production_id = 37),
  [1503] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_localnetwork, 4, .production_id = 72),
  ...
  [1511] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__preferred_authentications, 3, .production_id = 17),
  [1513] = {.entry = {.count = 1, .reusable = true}}, SHIFT(806),
  [1515] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__kex_algorithms, 5, .production_id = 51),
  [1517] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__cnames_map_repeat1, 2), SHIFT_REPEAT(108),
  [1520] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__proxy_string_repeat1, 1),
  [1522] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__proxy_string_repeat1, 1),
  [1524] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__pubkey_accepted_algorithms, 4, .production_id = 37),
  [1526] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__ca_signature_algorithms_repeat1, 2), SHIFT_REPEAT(815),
  [1529] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__ca_signature_algorithms_repeat1, 2),
  [1531] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__proxy_jump, 4, .production_id = 42),
  [1533] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__ca_signature_algorithms, 3, .production_id = 17),
  [1535] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__cnames_map, 4, .production_id = 73),
  [1537] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__string_repeat1, 2), SHIFT_REPEAT(326),
  [1540] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__string_repeat1, 2),
  [1542] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__host_key_algorithms, 5, .production_id = 51),
  [1544] = {.entry = {.count = 1, .reusable = true}}, SHIFT(512),
  [1546] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__cnames_map, 4, .production_id = 74),
  ...
  [1554] = {.entry = {.count = 1, .reusable = true}}, SHIFT(800),
  [1556] = {.entry = {.count = 1, .reusable = true}}, SHIFT(242),
  [1558] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__hostbased_accepted_algorithms, 3, .production_id = 17),
  [1560] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__preferred_authentications, 4, .production_id = 37),
  [1562] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__host_key_algorithms, 3, .production_id = 17),
  [1564] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__hostname_string_repeat1, 1),
  [1566] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__hostname_string_repeat1, 1),
  ...
  [1576] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__macs, 4, .production_id = 37),
  [1578] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__file_string_repeat2, 1),
  [1580] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__file_string_repeat2, 1),
  [1582] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__hostbased_accepted_algorithms_repeat1, 2), SHIFT_REPEAT(811),
  [1585] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__hostbased_accepted_algorithms_repeat1, 2),
  [1587] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__macs, 3, .production_id = 17),
  [1589] = {.entry = {.count = 1, .reusable = true}}, SHIFT(807),
  [1591] = {.entry = {.count = 1, .reusable = true}}, SHIFT(251),
  [1593] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__hostbased_accepted_algorithms, 5, .production_id = 51),
  [1595] = {.entry = {.count = 1, .reusable = true}}, SHIFT(676),
  [1597] = {.entry = {.count = 1, .reusable = true}}, SHIFT(147),
  [1599] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__log_verbose, 3, .production_id = 25),
  [1601] = {.entry = {.count = 1, .reusable = true}}, SHIFT(810),
  [1603] = {.entry = {.count = 1, .reusable = true}}, SHIFT(180),
  [1605] = {.entry = {.count = 1, .reusable = true}}, SHIFT(172),
  [1607] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__log_verbose, 4, .production_id = 40),
  [1609] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__match_value_repeat2, 2), SHIFT_REPEAT(206),
  [1612] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__match_value_repeat2, 2),
  [1614] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__kex_algorithms, 4, .production_id = 37),
  [1616] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__kex_algorithms, 3, .production_id = 17),
  [1618] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__ciphers_repeat1, 2), SHIFT_REPEAT(813),
  [1621] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__ciphers_repeat1, 2),
  [1623] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__ciphers, 5, .production_id = 51),
  [1625] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__token_string_repeat1, 1),
  [1627] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__token_string_repeat1, 1),
  [1629] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__file_string_repeat2, 1), REDUCE(aux_sym__string_repeat2, 1),
  [1632] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__file_string_repeat2, 1), REDUCE(aux_sym__string_repeat2, 1),
  [1635] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__match_localnetwork_repeat2, 2),
  [1637] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__match_localnetwork_repeat2, 2), SHIFT_REPEAT(777),
  [1640] = {.entry = {.count = 1, .reusable = true}}, SHIFT(575),
  [1642] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__dynamic_forward_repeat1, 2, .production_id = 59), SHIFT_REPEAT(57),
  [1645] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__dynamic_forward_repeat1, 2, .production_id = 59),
  [1647] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__global_known_hosts_file_repeat1, 2, .production_id = 46), SHIFT_REPEAT(181),
  [1650] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__global_known_hosts_file_repeat1, 2, .production_id = 46),
  [1652] = {.entry = {.count = 1, .reusable = true}}, SHIFT(556),
  [1654] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__forward_value_inner, 3, .production_id = 57),
  [1656] = {.entry = {.count = 1, .reusable = true}}, SHIFT(546),
  [1658] = {.entry = {.count = 1, .reusable = true}}, SHIFT(526),
  [1660] = {.entry = {.count = 1, .reusable = true}}, SHIFT(524),
  [1662] = {.entry = {.count = 1, .reusable = true}}, SHIFT(554),
  [1664] = {.entry = {.count = 1, .reusable = true}}, SHIFT(522),
  [1666] = {.entry = {.count = 1, .reusable = true}}, SHIFT(553),
  ...
  [1684] = {.entry = {.count = 1, .reusable = true}}, SHIFT(613),
  ...
  [1696] = {.entry = {.count = 1, .reusable = true}}, SHIFT(590),
  [1698] = {.entry = {.count = 1, .reusable = true}}, SHIFT(594),
  [1700] = {.entry = {.count = 1, .reusable = true}}, SHIFT(597),
  [1702] = {.entry = {.count = 1, .reusable = true}}, SHIFT(599),
  [1704] = {.entry = {.count = 1, .reusable = true}}, SHIFT(600),
  [1706] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__ignore_unknown_repeat1, 2), SHIFT_REPEAT(135),
  [1709] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__ignore_unknown_repeat1, 2),
  [1711] = {.entry = {.count = 1, .reusable = true}}, SHIFT(611),
  [1713] = {.entry = {.count = 1, .reusable = true}}, SHIFT(69),
  ...
  [1721] = {.entry = {.count = 1, .reusable = false}}, SHIFT(95),
  [1723] = {.entry = {.count = 1, .reusable = true}}, SHIFT(614),
  [1725] = {.entry = {.count = 1, .reusable = true}}, SHIFT(791),
  [1727] = {.entry = {.count = 1, .reusable = true}}, SHIFT(227),
  [1729] = {.entry = {.count = 1, .reusable = true}}, SHIFT(152),
  [1731] = {.entry = {.count = 1, .reusable = false}}, SHIFT(152),
  [1733] = {.entry = {.count = 1, .reusable = true}}, SHIFT(501),
  [1735] = {.entry = {.count = 1, .reusable = false}}, SHIFT(501),
  [1737] = {.entry = {.count = 1, .reusable = true}}, SHIFT(134),
  [1739] = {.entry = {.count = 1, .reusable = false}}, SHIFT(134),
  [1741] = {.entry = {.count = 1, .reusable = true}}, SHIFT(136),
  [1743] = {.entry = {.count = 1, .reusable = false}}, SHIFT(136),
  [1745] = {.entry = {.count = 1, .reusable = true}}, SHIFT(106),
  [1747] = {.entry = {.count = 1, .reusable = false}}, SHIFT(106),
  [1749] = {.entry = {.count = 1, .reusable = true}}, SHIFT(126),
  [1751] = {.entry = {.count = 1, .reusable = false}}, SHIFT(126),
  [1753] = {.entry = {.count = 1, .reusable = true}}, SHIFT(37),
  [1755] = {.entry = {.count = 1, .reusable = true}}, SHIFT(5),
  [1757] = {.entry = {.count = 1, .reusable = true}}, SHIFT(623),
  [1759] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__cnames_map_repeat1, 2), SHIFT_REPEAT(101),
  [1762] = {.entry = {.count = 1, .reusable = true}}, SHIFT(624),
  [1764] = {.entry = {.count = 1, .reusable = true}}, SHIFT(633),
  [1766] = {.entry = {.count = 1, .reusable = true}}, SHIFT(634),
  [1768] = {.entry = {.count = 1, .reusable = false}}, SHIFT(634),
  [1770] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__canonicalize_permitted_cnames_repeat1, 2, .production_id = 53), SHIFT_REPEAT(87),
  [1773] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__canonicalize_permitted_cnames_repeat1, 2, .production_id = 53),
  [1775] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__canonical_domains_repeat1, 2, .production_id = 46), SHIFT_REPEAT(99),
  [1778] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__canonical_domains_repeat1, 2, .production_id = 46),
  [1780] = {.entry = {.count = 1, .reusable = true}}, SHIFT(749),
  [1782] = {.entry = {.count = 1, .reusable = true}}, SHIFT(140),
  [1784] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__string_repeat2, 2),
  [1786] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__string_repeat2, 2), SHIFT_REPEAT(510),
  [1789] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__string, 3, .production_id = 50),
  [1791] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__log_verbose_repeat1, 2, .production_id = 63),
  [1793] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_match_declaration_repeat1, 2), SHIFT_REPEAT(39),
  [1796] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_match_declaration_repeat1, 2),
  [1798] = {.entry = {.count = 1, .reusable = true}}, SHIFT(779),
  [1800] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__permit_remote_open_repeat1, 2, .production_id = 67), SHIFT_REPEAT(96),
  [1803] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__permit_remote_open_repeat1, 2, .production_id = 67),
  [1805] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__proxy_jump_value, 3, .production_id = 65),
  [1807] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__proxy_jump_repeat1, 2, .production_id = 69),
  ...
  [1813] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__send_env_repeat1, 2, .production_id = 46), SHIFT_REPEAT(104),
  [1816] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__send_env_repeat1, 2, .production_id = 46),
  [1818] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__set_env_repeat1, 2, .production_id = 46), SHIFT_REPEAT(596),
  [1821] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__set_env_repeat1, 2, .production_id = 46),
  [1823] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__user_known_hosts_file_repeat1, 2, .production_id = 46), SHIFT_REPEAT(52),
  [1826] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__user_known_hosts_file_repeat1, 2, .production_id = 46),
  [1828] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__match_exec_repeat2, 1),
  [1830] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__match_exec_repeat2, 1),
  [1832] = {.entry = {.count = 1, .reusable = true}}, SHIFT(768),
  [1834] = {.entry = {.count = 1, .reusable = true}}, SHIFT(777),
  [1836] = {.entry = {.count = 1, .reusable = true}}, SHIFT(87),
  [1838] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__canonicalize_permitted_cnames, 3, .production_id = 19),
  [1840] = {.entry = {.count = 1, .reusable = true}}, SHIFT(101),
  [1842] = {.entry = {.count = 1, .reusable = true}}, SHIFT(102),
  [1844] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_host_declaration_repeat1, 2, .production_id = 46), SHIFT_REPEAT(79),
  [1847] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_host_declaration_repeat1, 2, .production_id = 46),
  [1849] = {.entry = {.count = 1, .reusable = true}}, SHIFT(290),
  [1851] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_time, 4),
  [1853] = {.entry = {.count = 1, .reusable = true}}, SHIFT(775),
  [1855] = {.entry = {.count = 1, .reusable = true}}, SHIFT(776),
  [1857] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__log_verbose_repeat2, 2, .production_id = 64),
  [1859] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__log_verbose_repeat2, 2, .production_id = 64), SHIFT_REPEAT(140),
  [1862] = {.entry = {.count = 1, .reusable = true}}, SHIFT(356),
  [1864] = {.entry = {.count = 1, .reusable = true}}, SHIFT(658),
  [1866] = {.entry = {.count = 1, .reusable = true}}, SHIFT(642),
  ...
  [1874] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__log_verbose_value, 5, .production_id = 80),
  [1876] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__proxy_jump_value, 5, .production_id = 82),
  [1878] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__match_value_repeat4, 2),
  [1880] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__match_value_repeat4, 2), SHIFT_REPEAT(261),
  [1883] = {.entry = {.count = 1, .reusable = true}}, SHIFT(593),
  [1885] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_time, 6),
  [1887] = {.entry = {.count = 1, .reusable = true}}, SHIFT(59),
  [1889] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [1891] = {.entry = {.count = 1, .reusable = true}}, SHIFT(796),
  [1893] = {.entry = {.count = 1, .reusable = true}}, SHIFT(799),
  [1895] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_time, 8),
  [1897] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__string_repeat1, 2), SHIFT_REPEAT(572),
  [1900] = {.entry = {.count = 1, .reusable = true}}, SHIFT(57),
  [1902] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__dynamic_forward, 3, .production_id = 21),
  [1904] = {.entry = {.count = 1, .reusable = true}}, SHIFT(52),
  [1906] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__user_known_hosts_file, 4, .production_id = 35),
  [1908] = {.entry = {.count = 1, .reusable = true}}, SHIFT(84),
  [1910] = {.entry = {.count = 1, .reusable = false}}, SHIFT(84),
  [1912] = {.entry = {.count = 1, .reusable = true}}, SHIFT(713),
  [1914] = {.entry = {.count = 1, .reusable = true}}, SHIFT(596),
  [1916] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__set_env, 4, .production_id = 35),
  [1918] = {.entry = {.count = 1, .reusable = true}}, SHIFT(294),
  [1920] = {.entry = {.count = 1, .reusable = false}}, SHIFT(294),
  [1922] = {.entry = {.count = 1, .reusable = true}}, SHIFT(233),
  [1924] = {.entry = {.count = 1, .reusable = false}}, SHIFT(233),
  [1926] = {.entry = {.count = 1, .reusable = true}}, SHIFT(104),
  [1928] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__send_env, 4, .production_id = 35),
  [1930] = {.entry = {.count = 1, .reusable = true}}, SHIFT(53),
  [1932] = {.entry = {.count = 1, .reusable = false}}, SHIFT(53),
  [1934] = {.entry = {.count = 1, .reusable = true}}, SHIFT(291),
  [1936] = {.entry = {.count = 1, .reusable = false}}, SHIFT(291),
  [1938] = {.entry = {.count = 1, .reusable = true}}, SHIFT(236),
  [1940] = {.entry = {.count = 1, .reusable = false}}, SHIFT(236),
  [1942] = {.entry = {.count = 1, .reusable = true}}, SHIFT(289),
  [1944] = {.entry = {.count = 1, .reusable = false}}, SHIFT(289),
  [1946] = {.entry = {.count = 1, .reusable = true}}, SHIFT(169),
  [1948] = {.entry = {.count = 1, .reusable = false}}, SHIFT(169),
  [1950] = {.entry = {.count = 1, .reusable = true}}, SHIFT(270),
  [1952] = {.entry = {.count = 1, .reusable = false}}, SHIFT(270),
  ...
  [1960] = {.entry = {.count = 1, .reusable = false}}, SHIFT(286),
  [1962] = {.entry = {.count = 1, .reusable = true}}, SHIFT(787),
  [1964] = {.entry = {.count = 1, .reusable = false}}, SHIFT(787),
  [1966] = {.entry = {.count = 1, .reusable = true}}, SHIFT(90),
  [1968] = {.entry = {.count = 1, .reusable = false}}, SHIFT(90),
  [1970] = {.entry = {.count = 1, .reusable = true}}, SHIFT(283),
  [1972] = {.entry = {.count = 1, .reusable = false}}, SHIFT(283),
  [1974] = {.entry = {.count = 1, .reusable = true}}, SHIFT(786),
  [1976] = {.entry = {.count = 1, .reusable = false}}, SHIFT(786),
  [1978] = {.entry = {.count = 1, .reusable = true}}, SHIFT(96),
  [1980] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__permit_remote_open, 4, .production_id = 41),
  [1982] = {.entry = {.count = 1, .reusable = true}}, SHIFT(281),
  [1984] = {.entry = {.count = 1, .reusable = false}}, SHIFT(281),
  [1986] = {.entry = {.count = 1, .reusable = true}}, SHIFT(659),
  [1988] = {.entry = {.count = 1, .reusable = false}}, SHIFT(659),
  [1990] = {.entry = {.count = 1, .reusable = true}}, SHIFT(279),
  [1992] = {.entry = {.count = 1, .reusable = false}}, SHIFT(279),
  [1994] = {.entry = {.count = 1, .reusable = true}}, SHIFT(661),
  [1996] = {.entry = {.count = 1, .reusable = false}}, SHIFT(661),
  [1998] = {.entry = {.count = 1, .reusable = true}}, SHIFT(696),
  [2000] = {.entry = {.count = 1, .reusable = true}}, SHIFT(663),
  [2002] = {.entry = {.count = 1, .reusable = false}}, SHIFT(663),
  [2004] = {.entry = {.count = 1, .reusable = true}}, SHIFT(138),
  [2006] = {.entry = {.count = 1, .reusable = false}}, SHIFT(138),
  [2008] = {.entry = {.count = 1, .reusable = true}}, SHIFT(137),
  [2010] = {.entry = {.count = 1, .reusable = false}}, SHIFT(137),
  [2012] = {.entry = {.count = 1, .reusable = true}}, SHIFT(70),
  [2014] = {.entry = {.count = 1, .reusable = false}}, SHIFT(70),
  [2016] = {.entry = {.count = 1, .reusable = true}}, SHIFT(665),
  [2018] = {.entry = {.count = 1, .reusable = false}}, SHIFT(665),
  [2020] = {.entry = {.count = 1, .reusable = true}}, SHIFT(145),
  [2022] = {.entry = {.count = 1, .reusable = false}}, SHIFT(145),
  [2024] = {.entry = {.count = 1, .reusable = true}}, SHIFT(41),
  [2026] = {.entry = {.count = 1, .reusable = false}}, SHIFT(41),
  [2028] = {.entry = {.count = 1, .reusable = true}}, SHIFT(133),
  [2030] = {.entry = {.count = 1, .reusable = false}}, SHIFT(133),
  [2032] = {.entry = {.count = 1, .reusable = true}}, SHIFT(135),
  [2034] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__ignore_unknown, 3, .production_id = 17),
  [2036] = {.entry = {.count = 1, .reusable = true}}, SHIFT(285),
  [2038] = {.entry = {.count = 1, .reusable = false}}, SHIFT(285),
  [2040] = {.entry = {.count = 1, .reusable = true}}, SHIFT(124),
  [2042] = {.entry = {.count = 1, .reusable = false}}, SHIFT(124),
  [2044] = {.entry = {.count = 1, .reusable = true}}, SHIFT(258),
  [2046] = {.entry = {.count = 1, .reusable = false}}, SHIFT(258),
  [2048] = {.entry = {.count = 1, .reusable = true}}, SHIFT(685),
  [2050] = {.entry = {.count = 1, .reusable = true}}, SHIFT(278),
  [2052] = {.entry = {.count = 1, .reusable = false}}, SHIFT(278),
  [2054] = {.entry = {.count = 1, .reusable = true}}, SHIFT(148),
  [2056] = {.entry = {.count = 1, .reusable = false}}, SHIFT(148),
  [2058] = {.entry = {.count = 1, .reusable = true}}, SHIFT(121),
  [2060] = {.entry = {.count = 1, .reusable = false}}, SHIFT(121),
  [2062] = {.entry = {.count = 1, .reusable = true}}, SHIFT(785),
  [2064] = {.entry = {.count = 1, .reusable = false}}, SHIFT(785),
  [2066] = {.entry = {.count = 1, .reusable = true}}, SHIFT(667),
  [2068] = {.entry = {.count = 1, .reusable = false}}, SHIFT(667),
  [2070] = {.entry = {.count = 1, .reusable = true}}, SHIFT(254),
  [2072] = {.entry = {.count = 1, .reusable = false}}, SHIFT(254),
  [2074] = {.entry = {.count = 1, .reusable = true}}, SHIFT(116),
  [2076] = {.entry = {.count = 1, .reusable = false}}, SHIFT(116),
  [2078] = {.entry = {.count = 1, .reusable = true}}, SHIFT(284),
  [2080] = {.entry = {.count = 1, .reusable = false}}, SHIFT(284),
  [2082] = {.entry = {.count = 1, .reusable = true}}, SHIFT(282),
  [2084] = {.entry = {.count = 1, .reusable = false}}, SHIFT(282),
  [2086] = {.entry = {.count = 1, .reusable = true}}, SHIFT(668),
  [2088] = {.entry = {.count = 1, .reusable = false}}, SHIFT(668),
  [2090] = {.entry = {.count = 1, .reusable = true}}, SHIFT(275),
  [2092] = {.entry = {.count = 1, .reusable = false}}, SHIFT(275),
  [2094] = {.entry = {.count = 1, .reusable = true}}, SHIFT(252),
  [2096] = {.entry = {.count = 1, .reusable = false}}, SHIFT(252),
  [2098] = {.entry = {.count = 1, .reusable = true}}, SHIFT(114),
  [2100] = {.entry = {.count = 1, .reusable = false}}, SHIFT(114),
  [2102] = {.entry = {.count = 1, .reusable = true}}, SHIFT(784),
  [2104] = {.entry = {.count = 1, .reusable = false}}, SHIFT(784),
  [2106] = {.entry = {.count = 1, .reusable = true}}, SHIFT(42),
  [2108] = {.entry = {.count = 1, .reusable = false}}, SHIFT(42),
  [2110] = {.entry = {.count = 1, .reusable = true}}, SHIFT(248),
  [2112] = {.entry = {.count = 1, .reusable = false}}, SHIFT(248),
  [2114] = {.entry = {.count = 1, .reusable = true}}, SHIFT(76),
  [2116] = {.entry = {.count = 1, .reusable = false}}, SHIFT(76),
  [2118] = {.entry = {.count = 1, .reusable = true}}, SHIFT(246),
  [2120] = {.entry = {.count = 1, .reusable = false}}, SHIFT(246),
  [2122] = {.entry = {.count = 1, .reusable = true}}, SHIFT(288),
  [2124] = {.entry = {.count = 1, .reusable = false}}, SHIFT(288),
  [2126] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__ignore_unknown, 4, .production_id = 37),
  [2128] = {.entry = {.count = 1, .reusable = true}}, SHIFT(245),
  [2130] = {.entry = {.count = 1, .reusable = false}}, SHIFT(245),
  [2132] = {.entry = {.count = 1, .reusable = true}}, SHIFT(92),
  [2134] = {.entry = {.count = 1, .reusable = false}}, SHIFT(92),
  [2136] = {.entry = {.count = 1, .reusable = true}}, SHIFT(94),
  [2138] = {.entry = {.count = 1, .reusable = false}}, SHIFT(94),
  [2140] = {.entry = {.count = 1, .reusable = true}}, SHIFT(74),
  [2142] = {.entry = {.count = 1, .reusable = false}}, SHIFT(74),
  [2144] = {.entry = {.count = 1, .reusable = true}}, SHIFT(47),
  [2146] = {.entry = {.count = 1, .reusable = false}}, SHIFT(47),
  ...
  [2152] = {.entry = {.count = 1, .reusable = false}}, SHIFT(272),
  [2154] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__hostname_string_repeat2, 1),
  [2156] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__hostname_string_repeat2, 1),
  [2158] = {.entry = {.count = 1, .reusable = true}}, SHIFT(98),
  [2160] = {.entry = {.count = 1, .reusable = false}}, SHIFT(98),
  [2162] = {.entry = {.count = 1, .reusable = true}}, SHIFT(239),
  [2164] = {.entry = {.count = 1, .reusable = false}}, SHIFT(239),
  [2166] = {.entry = {.count = 1, .reusable = true}}, SHIFT(238),
  [2168] = {.entry = {.count = 1, .reusable = false}}, SHIFT(238),
  [2170] = {.entry = {.count = 1, .reusable = true}}, SHIFT(287),
  [2172] = {.entry = {.count = 1, .reusable = false}}, SHIFT(287),
  [2174] = {.entry = {.count = 1, .reusable = true}}, SHIFT(237),
  [2176] = {.entry = {.count = 1, .reusable = false}}, SHIFT(237),
  [2178] = {.entry = {.count = 1, .reusable = true}}, SHIFT(292),
  [2180] = {.entry = {.count = 1, .reusable = false}}, SHIFT(292),
  [2182] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__proxy_jump_value, 1, .production_id = 28),
  [2184] = {.entry = {.count = 1, .reusable = true}}, SHIFT(293),
  [2186] = {.entry = {.count = 1, .reusable = false}}, SHIFT(293),
  [2188] = {.entry = {.count = 1, .reusable = true}}, SHIFT(234),
  [2190] = {.entry = {.count = 1, .reusable = false}}, SHIFT(234),
  [2192] = {.entry = {.count = 1, .reusable = true}}, SHIFT(295),
  [2194] = {.entry = {.count = 1, .reusable = false}}, SHIFT(295),
  [2196] = {.entry = {.count = 1, .reusable = true}}, SHIFT(671),
  [2198] = {.entry = {.count = 1, .reusable = false}}, SHIFT(671),
  [2200] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__global_known_hosts_file, 4, .production_id = 35),
  [2202] = {.entry = {.count = 1, .reusable = true}}, SHIFT(296),
  [2204] = {.entry = {.count = 1, .reusable = false}}, SHIFT(296),
  [2206] = {.entry = {.count = 1, .reusable = true}}, SHIFT(587),
  [2208] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bytes, 1),
  [2210] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__dynamic_forward, 4, .production_id = 38),
  [2212] = {.entry = {.count = 1, .reusable = true}}, SHIFT(54),
  [2214] = {.entry = {.count = 1, .reusable = false}}, SHIFT(54),
  [2216] = {.entry = {.count = 1, .reusable = true}}, SHIFT(297),
  [2218] = {.entry = {.count = 1, .reusable = false}}, SHIFT(297),
  [2220] = {.entry = {.count = 1, .reusable = true}}, SHIFT(612),
  [2222] = {.entry = {.count = 1, .reusable = false}}, SHIFT(612),
  [2224] = {.entry = {.count = 1, .reusable = true}}, SHIFT(298),
  [2226] = {.entry = {.count = 1, .reusable = false}}, SHIFT(298),
  [2228] = {.entry = {.count = 1, .reusable = true}}, SHIFT(675),
  [2230] = {.entry = {.count = 1, .reusable = false}}, SHIFT(675),
  [2232] = {.entry = {.count = 1, .reusable = true}}, SHIFT(299),
  [2234] = {.entry = {.count = 1, .reusable = false}}, SHIFT(299),
  [2236] = {.entry = {.count = 1, .reusable = true}}, SHIFT(300),
  [2238] = {.entry = {.count = 1, .reusable = false}}, SHIFT(300),
  [2240] = {.entry = {.count = 1, .reusable = true}}, SHIFT(56),
  [2242] = {.entry = {.count = 1, .reusable = false}}, SHIFT(56),
  [2244] = {.entry = {.count = 1, .reusable = true}}, SHIFT(51),
  [2246] = {.entry = {.count = 1, .reusable = false}}, SHIFT(51),
  [2248] = {.entry = {.count = 1, .reusable = true}}, SHIFT(157),
  [2250] = {.entry = {.count = 1, .reusable = false}}, SHIFT(157),
  [2252] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__send_env, 3, .production_id = 17),
  [2254] = {.entry = {.count = 1, .reusable = true}}, SHIFT(89),
  [2256] = {.entry = {.count = 1, .reusable = false}}, SHIFT(89),
  [2258] = {.entry = {.count = 1, .reusable = true}}, SHIFT(677),
  [2260] = {.entry = {.count = 1, .reusable = false}}, SHIFT(677),
  [2262] = {.entry = {.count = 1, .reusable = true}}, SHIFT(678),
  [2264] = {.entry = {.count = 1, .reusable = false}}, SHIFT(678),
  [2266] = {.entry = {.count = 1, .reusable = true}}, SHIFT(119),
  [2268] = {.entry = {.count = 1, .reusable = true}}, SHIFT(302),
  [2270] = {.entry = {.count = 1, .reusable = false}}, SHIFT(302),
  [2272] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__set_env, 3, .production_id = 17),
  [2274] = {.entry = {.count = 1, .reusable = true}}, SHIFT(304),
  [2276] = {.entry = {.count = 1, .reusable = false}}, SHIFT(304),
  [2278] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__canonicalize_permitted_cnames, 4, .production_id = 36),
  [2280] = {.entry = {.count = 1, .reusable = true}}, SHIFT(215),
  [2282] = {.entry = {.count = 1, .reusable = false}}, SHIFT(215),
  [2284] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__canonical_domains, 4, .production_id = 35),
  [2286] = {.entry = {.count = 1, .reusable = true}}, SHIFT(306),
  [2288] = {.entry = {.count = 1, .reusable = false}}, SHIFT(306),
  [2290] = {.entry = {.count = 1, .reusable = true}}, SHIFT(789),
  [2292] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_time, 2),
  [2294] = {.entry = {.count = 1, .reusable = true}}, SHIFT(641),
  [2296] = {.entry = {.count = 1, .reusable = true}}, SHIFT(324),
  [2298] = {.entry = {.count = 1, .reusable = true}}, SHIFT(368),
  [2300] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__tunnel_device, 3, .production_id = 17),
  [2302] = {.entry = {.count = 1, .reusable = true}}, SHIFT(196),
  [2304] = {.entry = {.count = 1, .reusable = true}}, SHIFT(48),
  [2306] = {.entry = {.count = 1, .reusable = false}}, SHIFT(48),
  ...
  [2312] = {.entry = {.count = 1, .reusable = true}}, SHIFT(510),
  [2314] = {.entry = {.count = 1, .reusable = true}}, SHIFT(38),
  [2316] = {.entry = {.count = 1, .reusable = true}}, SHIFT(307),
  [2318] = {.entry = {.count = 1, .reusable = false}}, SHIFT(307),
  [2320] = {.entry = {.count = 1, .reusable = true}}, SHIFT(61),
  [2322] = {.entry = {.count = 1, .reusable = false}}, SHIFT(61),
  [2324] = {.entry = {.count = 1, .reusable = true}}, SHIFT(679),
  [2326] = {.entry = {.count = 1, .reusable = false}}, SHIFT(679),
  [2328] = {.entry = {.count = 1, .reusable = true}}, SHIFT(71),
  [2330] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [2332] = {.entry = {.count = 1, .reusable = true}}, SHIFT(317),
  [2334] = {.entry = {.count = 1, .reusable = false}}, SHIFT(317),
  [2336] = {.entry = {.count = 1, .reusable = true}}, SHIFT(319),
  [2338] = {.entry = {.count = 1, .reusable = false}}, SHIFT(319),
  [2340] = {.entry = {.count = 1, .reusable = true}}, SHIFT(112),
  [2342] = {.entry = {.count = 1, .reusable = false}}, SHIFT(112),
  [2344] = {.entry = {.count = 1, .reusable = true}}, SHIFT(115),
  [2346] = {.entry = {.count = 1, .reusable = false}}, SHIFT(115),
  [2348] = {.entry = {.count = 1, .reusable = true}}, SHIFT(68),
  [2350] = {.entry = {.count = 1, .reusable = true}}, SHIFT(16),
  [2352] = {.entry = {.count = 1, .reusable = true}}, SHIFT(118),
  [2354] = {.entry = {.count = 1, .reusable = false}}, SHIFT(118),
  [2356] = {.entry = {.count = 1, .reusable = true}}, SHIFT(320),
  [2358] = {.entry = {.count = 1, .reusable = false}}, SHIFT(320),
  [2360] = {.entry = {.count = 1, .reusable = true}}, SHIFT(321),
  [2362] = {.entry = {.count = 1, .reusable = false}}, SHIFT(321),
  [2364] = {.entry = {.count = 1, .reusable = true}}, SHIFT(75),
  [2366] = {.entry = {.count = 1, .reusable = false}}, SHIFT(75),
  [2368] = {.entry = {.count = 1, .reusable = true}}, SHIFT(202),
  [2370] = {.entry = {.count = 1, .reusable = false}}, SHIFT(202),
  [2372] = {.entry = {.count = 1, .reusable = true}}, SHIFT(36),
  [2374] = {.entry = {.count = 1, .reusable = false}}, SHIFT(36),
  [2376] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__forward_value1, 1, .production_id = 24),
  [2378] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 1, .production_id = 1),
  [2380] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition, 2, .production_id = 34),
  [2382] = {.entry = {.count = 1, .reusable = true}}, SHIFT(620),
  [2384] = {.entry = {.count = 1, .reusable = true}}, SHIFT(621),
  [2386] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition, 2, .production_id = 33),
  [2388] = {.entry = {.count = 1, .reusable = false}}, SHIFT(790),
  [2390] = {.entry = {.count = 1, .reusable = false}}, SHIFT(186),
  [2392] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__xauth_location, 3, .production_id = 17),
  [2394] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__string_repeat2, 1),
  [2396] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__visual_host_key, 3, .production_id = 17),
  [2398] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__verify_host_key_dns, 3, .production_id = 17),
  [2400] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__use_keychain, 3, .production_id = 18),
  [2402] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__update_host_keys, 3, .production_id = 17),
  [2404] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__tunnel, 3, .production_id = 17),
  [2406] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__tag, 3, .production_id = 17),
  [2408] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__tcp_keep_alive, 3, .production_id = 17),
  [2410] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__syslog_facility, 3, .production_id = 17),
  [2412] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__strict_host_key_checking, 3, .production_id = 17),
  [2414] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__stream_local_bind_unlink, 3, .production_id = 17),
  [2416] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__stream_local_bind_mask, 3, .production_id = 17),
  [2418] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__stdin_null, 3, .production_id = 17),
  [2420] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__session_type, 3, .production_id = 17),
  [2422] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__server_alive_interval, 3, .production_id = 17),
  [2424] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__server_alive_count_max, 3, .production_id = 17),
  [2426] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__security_key_provider, 3, .production_id = 17),
  [2428] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__security_key_provider, 3, .production_id = 23),
  [2430] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__revoked_host_keys, 3, .production_id = 17),
  [2432] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__required_rsa_size, 3, .production_id = 17),
  [2434] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__request_tty, 3, .production_id = 17),
  [2436] = {.entry = {.count = 1, .reusable = true}}, SHIFT(46),
  [2438] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__remote_forward, 3, .production_id = 31),
  [2440] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__var_value, 2, .production_id = 39),
  [2442] = {.entry = {.count = 1, .reusable = true}}, SHIFT(588),
  [2444] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__rekey_limit, 3, .production_id = 17),
  [2446] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__pubkey_authentication, 3, .production_id = 17),
  [2448] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__proxy_use_fdpass, 3, .production_id = 17),
  [2450] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 1, .production_id = 2),
  [2452] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__proxy_command, 3, .production_id = 17),
  [2454] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__port, 3, .production_id = 17),
  [2456] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__pkcs11_provider, 3, .production_id = 17),
  [2458] = {.entry = {.count = 1, .reusable = false}}, SHIFT(802),
  [2460] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__permit_local_command, 3, .production_id = 17),
  [2462] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__password_authentication, 3, .production_id = 17),
  [2464] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__number_of_password_prompts, 3, .production_id = 17),
  [2466] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__no_host_authentication_for_localhost, 3, .production_id = 17),
  [2468] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__log_level, 3, .production_id = 17),
  [2470] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__forward_value1, 1, .production_id = 22),
  [2472] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__forward_value1, 1, .production_id = 20),
  [2474] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__local_command, 3, .production_id = 17),
  [2476] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__known_hosts_command, 3, .production_id = 17),
  [2478] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__clear_all_forwardings, 3, .production_id = 17),
  [2480] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__kbd_interactive_authentication, 3, .production_id = 17),
  [2482] = {.entry = {.count = 1, .reusable = true}}, SHIFT(256),
  [2484] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__ipqos, 3, .production_id = 17),
  [2486] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__include, 3, .production_id = 17),
  [2488] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__identity_file, 3, .production_id = 17),
  [2490] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__identity_agent, 3, .production_id = 23),
  [2492] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__string_repeat1, 1),
  [2494] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__identity_agent, 3, .production_id = 17),
  [2496] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__identities_only, 3, .production_id = 17),
  [2498] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__hostname, 3, .production_id = 17),
  [2500] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__host_key_alias, 3, .production_id = 17),
  [2502] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_time, 10),
  [2504] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__hostbased_authentication, 3, .production_id = 17),
  [2506] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__gssapi_delegate_credentials, 3, .production_id = 17),
  [2508] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__gssapi_authentication, 3, .production_id = 17),
  [2510] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__forward_x11_trusted, 3, .production_id = 17),
  [2512] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bytes, 2),
  [2514] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__forward_x11_timeout, 3, .production_id = 17),
  [2516] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__forward_x11, 3, .production_id = 17),
  [2518] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__forward_agent, 3, .production_id = 17),
  [2520] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__forward_agent, 3, .production_id = 23),
  [2522] = {.entry = {.count = 1, .reusable = true}}, SHIFT(362),
  [2524] = {.entry = {.count = 1, .reusable = true}}, SHIFT(581),
  [2526] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__fork_after_authentication, 3, .production_id = 17),
  [2528] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__fingerprint_hash, 3, .production_id = 17),
  [2530] = {.entry = {.count = 1, .reusable = true}}, SHIFT(816),
  [2532] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__exit_on_forward_failure, 3, .production_id = 17),
  [2534] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__escape_char, 3, .production_id = 17),
  [2536] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__enable_ssh_keysign, 3, .production_id = 17),
  [2538] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__enable_escape_command_line, 3, .production_id = 17),
  [2540] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__dynamic_forward_value, 1, .production_id = 22),
  [2542] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__dynamic_forward_value, 1, .production_id = 20),
  [2544] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__log_verbose_quoted, 5, .production_id = 80),
  [2546] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__control_path, 3, .production_id = 17),
  [2548] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__control_persist, 3, .production_id = 17),
  [2550] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__control_master, 3, .production_id = 17),
  [2552] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__connect_timeout, 3, .production_id = 17),
  [2554] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__connection_attempts, 3, .production_id = 17),
  [2556] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_host_declaration_repeat1, 2, .production_id = 45),
  [2558] = {.entry = {.count = 1, .reusable = true}}, SHIFT(782),
  [2560] = {.entry = {.count = 1, .reusable = true}}, SHIFT(35),
  [2562] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__compression, 3, .production_id = 17),
  [2564] = {.entry = {.count = 1, .reusable = true}}, SHIFT(595),
  [2566] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__check_host_ip, 3, .production_id = 17),
  [2568] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__certificate_file, 3, .production_id = 17),
  [2570] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_host, 3, .production_id = 47),
  [2572] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__canonicalize_permitted_cnames, 3, .production_id = 18),
  ...
  [2578] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__canonicalize_max_dots, 3, .production_id = 17),
  [2580] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__canonicalize_hostname, 3, .production_id = 17),
  [2582] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__canonicalize_fallback_local, 3, .production_id = 17),
  [2584] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__bind_interface, 3, .production_id = 17),
  [2586] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_originalhost, 3, .production_id = 49),
  [2588] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_tagged, 3, .production_id = 49),
  [2590] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_user, 3, .production_id = 49),
  [2592] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_localuser, 3, .production_id = 49),
  [2594] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__bind_address, 3, .production_id = 17),
  [2596] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__batch_mode, 3, .production_id = 17),
  [2598] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__address_family, 3, .production_id = 17),
  [2600] = {.entry = {.count = 1, .reusable = true}}, SHIFT(513),
  [2602] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__add_keys_to_agent, 3, .production_id = 17),
  [2604] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__user, 3, .production_id = 15),
  [2606] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__add_keys_to_agent, 5, .production_id = 51),
  [2608] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition, 1, .production_id = 14),
  [2610] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_localnetwork, 6, .production_id = 83),
  [2612] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__canonical_domains_repeat1, 2, .production_id = 45),
  [2614] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__canonicalize_permitted_cnames_repeat1, 2, .production_id = 52),
  [2616] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition, 1, .production_id = 13),
  [2618] = {.entry = {.count = 1, .reusable = true}}, SHIFT(817),
  [2620] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__file_pattern_vars, 3, .production_id = 44),
  [2622] = {.entry = {.count = 1, .reusable = true}}, SHIFT(818),
  [2624] = {.entry = {.count = 1, .reusable = true}}, SHIFT(25),
  [2626] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 1, .production_id = 3),
  [2628] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_value, 4, .production_id = 44),
  [2630] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__dynamic_forward_value, 3, .production_id = 56),
  [2632] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__dynamic_forward_repeat1, 2, .production_id = 58),
  [2634] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__global_known_hosts_file_repeat1, 2, .production_id = 45),
  [2636] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__hostname_string, 3, .production_id = 50),
  [2638] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__file_string, 3, .production_id = 50),
  [2640] = {.entry = {.count = 1, .reusable = true}}, SHIFT(598),
  [2642] = {.entry = {.count = 1, .reusable = false}}, SHIFT(598),
  [2644] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__ipqos, 5, .production_id = 60),
  [2646] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__forward_value1, 3, .production_id = 56),
  [2648] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__forward_value2, 1, .production_id = 20),
  [2650] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__local_forward, 5, .production_id = 61),
  [2652] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__forward_value2, 1, .production_id = 24),
  [2654] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__log_verbose, 5, .production_id = 62),
  [2656] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 1, .production_id = 10),
  [2658] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 1, .production_id = 9),
  [2660] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__permit_remote_open_value, 3, .production_id = 65),
  [2662] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__permit_remote_open_repeat1, 2, .production_id = 66),
  [2664] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__rekey_limit, 5, .production_id = 60),
  [2666] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__remote_forward, 5, .production_id = 61),
  [2668] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__send_env_repeat1, 2, .production_id = 45),
  [2670] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__set_env_value, 3, .production_id = 32),
  [2672] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__set_env_repeat1, 2, .production_id = 45),
  [2674] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__tunnel_device, 5, .production_id = 51),
  [2676] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__user_known_hosts_file_repeat1, 2, .production_id = 45),
  [2678] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 1, .production_id = 4),
  [2680] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 1, .production_id = 5),
  [2682] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_host_declaration_repeat1, 3, .production_id = 71),
  [2684] = {.entry = {.count = 1, .reusable = true}}, SHIFT(778),
  [2686] = {.entry = {.count = 1, .reusable = true}}, SHIFT(27),
  [2688] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 1, .production_id = 8),
  [2690] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 1, .production_id = 7),
  [2692] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__permit_remote_open_value, 5, .production_id = 81),
  [2694] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 1, .production_id = 6),
  [2696] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__log_verbose_repeat2, 2, .production_id = 63),
  [2698] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__log_verbose, 6, .production_id = 75),
  [2700] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__forward_value2, 3, .production_id = 56),
  [2702] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_value, 3, .production_id = 44),
  [2704] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_exec, 5, .production_id = 77),
  [2706] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__match_localnetwork, 5, .production_id = 78),
  [2708] = {.entry = {.count = 1, .reusable = true}}, SHIFT(656),
  [2710] = {.entry = {.count = 1, .reusable = true}}, SHIFT(23),
  [2712] = {.entry = {.count = 1, .reusable = true}}, SHIFT(736),
  [2714] = {.entry = {.count = 1, .reusable = true}}, SHIFT(759),
  [2716] = {.entry = {.count = 1, .reusable = true}}, SHIFT(353),
  [2718] = {.entry = {.count = 1, .reusable = true}}, SHIFT(559),
  [2720] = {.entry = {.count = 1, .reusable = true}}, SHIFT(217),
  [2722] = {.entry = {.count = 1, .reusable = true}}, SHIFT(523),
  [2724] = {.entry = {.count = 1, .reusable = true}}, SHIFT(520),
  [2726] = {.entry = {.count = 1, .reusable = true}}, SHIFT(342),
  [2728] = {.entry = {.count = 1, .reusable = true}}, SHIFT(213),
  [2730] = {.entry = {.count = 1, .reusable = true}}, SHIFT(814),
  [2732] = {.entry = {.count = 1, .reusable = true}}, SHIFT(191),
  [2734] = {.entry = {.count = 1, .reusable = true}}, SHIFT(537),
  [2736] = {.entry = {.count = 1, .reusable = true}}, SHIFT(540),
  [2738] = {.entry = {.count = 1, .reusable = true}}, SHIFT(179),
  [2740] = {.entry = {.count = 1, .reusable = true}}, SHIFT(187),
  [2742] = {.entry = {.count = 1, .reusable = true}}, SHIFT(579),
  [2744] = {.entry = {.count = 1, .reusable = true}}, SHIFT(175),
  [2746] = {.entry = {.count = 1, .reusable = true}}, SHIFT(334),
  [2748] = {.entry = {.count = 1, .reusable = true}}, SHIFT(332),
  [2750] = {.entry = {.count = 1, .reusable = true}}, SHIFT(331),
  [2752] = {.entry = {.count = 1, .reusable = true}}, SHIFT(680),
  [2754] = {.entry = {.count = 1, .reusable = true}}, SHIFT(45),
  [2756] = {.entry = {.count = 1, .reusable = true}}, SHIFT(308),
  [2758] = {.entry = {.count = 1, .reusable = true}}, SHIFT(253),
  [2760] = {.entry = {.count = 1, .reusable = true}}, SHIFT(390),
  [2762] = {.entry = {.count = 1, .reusable = true}}, SHIFT(798),
  [2764] = {.entry = {.count = 1, .reusable = true}}, SHIFT(224),
  [2766] = {.entry = {.count = 1, .reusable = true}}, SHIFT(276),
  [2768] = {.entry = {.count = 1, .reusable = true}}, SHIFT(660),
  [2770] = {.entry = {.count = 1, .reusable = true}}, SHIFT(280),
  [2772] = {.entry = {.count = 1, .reusable = true}}, SHIFT(77),
  [2774] = {.entry = {.count = 1, .reusable = true}}, SHIFT(316),
  [2776] = {.entry = {.count = 1, .reusable = true}}, SHIFT(174),
  [2778] = {.entry = {.count = 1, .reusable = true}}, SHIFT(22),
  [2780] = {.entry = {.count = 1, .reusable = true}}, SHIFT(263),
  [2782] = {.entry = {.count = 1, .reusable = true}}, SHIFT(165),
  [2784] = {.entry = {.count = 1, .reusable = true}},  ACCEPT_INPUT(),
  [2786] = {.entry = {.count = 1, .reusable = true}}, SHIFT(161),
  [2788] = {.entry = {.count = 1, .reusable = true}}, SHIFT(160),
  [2790] = {.entry = {.count = 1, .reusable = true}}, SHIFT(110),
  [2792] = {.entry = {.count = 1, .reusable = true}}, SHIFT(219),
  [2794] = {.entry = {.count = 1, .reusable = true}}, SHIFT(820),
  [2796] = {.entry = {.count = 1, .reusable = true}}, SHIFT(822),
  [2798] = {.entry = {.count = 1, .reusable = true}}, SHIFT(823),
  [2800] = {.entry = {.count = 1, .reusable = true}}, SHIFT(824),
  [2802] = {.entry = {.count = 1, .reusable = true}}, SHIFT(825),
};
